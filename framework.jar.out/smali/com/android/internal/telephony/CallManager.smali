...
.method private handleSpeechInfo(Landroid/os/Message;)Z
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/CallManager;->isEspeechTurnedOff(I)Z
    ...
    const-string v14, "Set audio mode to NORMAL"
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/CallManager;->setAudioMode(I)V
    ...
    iput v7, v0, Lcom/android/internal/telephony/CallManager;->mDualModemCall:I
    ...
    const-string/jumbo v15, "set mDualModemCall = "
    ...
    iget v15, v0, Lcom/android/internal/telephony/CallManager;->mDualModemCall:I
...
.method private setAudioMode(I)V
    ...
    const-string/jumbo v11, "setAudioMode enter..."
    ...
    const-string/jumbo v12, "set mode = "
    ...
    const-string v11, "Do not need to switch normal mode for held call"
    ...
    const-string/jumbo v11, "no fg/bg call but ring call is exist, allow to set ringtone mode"
    ...
    const-string/jumbo v11, "requestAudioFocus on STREAM_RING"
    ...
    invoke-virtual {v0, v10, v11}, Landroid/media/AudioManager;->requestAudioFocusForCall(II)V
    ...
    const-string/jumbo v11, "there is fg or bg call exist, we don\'t allow to set ringtone mode"
    ...
    const-string/jumbo v11, "requestAudioFocus on STREAM_VOICE_CALL"
    ...
    new-instance v11, Lcom/android/internal/telephony/CallManager$2;

    invoke-direct {v11, p0, v9}, Lcom/android/internal/telephony/CallManager$2;-><init>(Lcom/android/internal/telephony/CallManager;I)V
    ...
    const-string/jumbo v12, "set AudioManager mode "
    ...
    .line 3054
    iget-boolean v10, p0, Lcom/android/internal/telephony/CallManager;->mSpeedUpAudioForMtCall:Z
    ...
    .local v7, newDualModemCall:I
    :goto_3
    iget v10, p0, Lcom/android/internal/telephony/CallManager;->mDualModemCall:I

    if-eq v7, v10, :cond_6

    .line 3062
    iput v7, p0, Lcom/android/internal/telephony/CallManager;->mDualModemCall:I
    ...
    const-string/jumbo v12, "set mDualModemCall = "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/internal/telephony/CallManager;->mDualModemCall:I
    ...
    iput v10, p0, Lcom/android/internal/telephony/CallManager;->mCurrentAudioMode:I

    .line 3084
    const/4 v10, 0x0

    iput-boolean v10, p0, Lcom/android/internal/telephony/CallManager;->mSpeedUpAudioForMtCall:Z
    ...
    const-string v11, "abandonAudioFocus"
    ...
    .line 3071
    .restart local v7       #newDualModemCall:I
    :cond_c
    const/4 v8, 0x2
...
.method public registerForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-virtual {v3, v4, v5, v7, v8}, Lcom/android/internal/telephony/gemini/GeminiPhone;->registerForCallWaitingGemini(Landroid/os/Handler;ILjava/lang/Object;I)V
    ...
    invoke-virtual {p1, v3, v4, v7, v8}, Lcom/android/internal/telephony/gemini/GeminiPhone;->registerForCdmaOtaStatusChangeGemini(Landroid/os/Handler;ILjava/lang/Object;I)V
...
.method public setAudioMode()V
    ...
    .line 711
    .local v0, mode:I
    sget-object v3, Lcom/android/internal/telephony/CallManager$3;->$SwitchMap$com$android$internal$telephony$PhoneConstants$State:[I
    ...
    .line 780
    .local v1, newDualModemCall:I
    :goto_1
    iget v3, p0, Lcom/android/internal/telephony/CallManager;->mDualModemCall:I
    ...
    const-string/jumbo v5, "set mDualModemCall = "
    ...
    invoke-direct {p0, v3, v6}, Lcom/android/internal/telephony/CallManager;->setAudioModeDualModem(II)V

    .line 790
    .end local v1           #newDualModemCall:I
    :goto_2
    return-void
    ...
    .line 779
    .end local v2           #offhookPhone:Lcom/android/internal/telephony/Phone;
    :cond_3
    const/4 v1, 0x0
...
.method public unregisterForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-virtual {v2, v6, v3, v6, v4}, Lcom/android/internal/telephony/gemini/GeminiPhone;->setOnPostDialCharacterGemini(Landroid/os/Handler;ILjava/lang/Object;I)V
    ...
    invoke-virtual {v2, v3, v5}, Lcom/android/internal/telephony/gemini/GeminiPhone;->unregisterForCallWaitingGemini(Landroid/os/Handler;I)V
    ...
    invoke-virtual {p1, v2, v5}, Lcom/android/internal/telephony/gemini/GeminiPhone;->unregisterForCdmaOtaStatusChangeGemini(Landroid/os/Handler;I)V
