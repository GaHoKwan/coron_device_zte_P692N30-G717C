...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/SmsUsageMonitor;)V
    ...
    const v6, #android:bool@config_sms_capable#t
...
.method checkDestination(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)Z
    ...
    invoke-interface {v7, v10}, Lcom/android/internal/telephony/ITelephony;->getSimCountryIso(I)Ljava/lang/String;
    ...
    invoke-interface {v7, v10}, Lcom/android/internal/telephony/ITelephony;->getNetworkCountryIsoGemini(I)Ljava/lang/String;
    ...
    invoke-virtual {v10, v11, v5}, Lcom/android/internal/telephony/SmsUsageMonitor;->checkDestination(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v6, v10}, Lcom/android/internal/telephony/SmsUsageMonitor;->mergeShortCodeCategories(II)I
    ...
    .line 1809
    .local v3, premiumSmsPermission:I
    if-nez v3, :cond_a
    ...
    .line 1836
    .end local v3           #premiumSmsPermission:I
    .end local v4           #rule:I
    .end local v6           #smsCategory:I
    ...
    const-string v11, "SD-handleSendComplete: RemoteException: "
    ...
    .line 1820
    .restart local v3       #premiumSmsPermission:I
    .restart local v4       #rule:I
    .restart local v6       #smsCategory:I
...
.method protected processMessagePart(Lcom/android/internal/telephony/SmsMessageBase;Lcom/android/internal/telephony/SmsHeader$ConcatRef;Lcom/android/internal/telephony/SmsHeader$PortAddrs;)I
    ...
    .line 2419
    .local v21, sca:Ljava/lang/String;
    if-nez v21, :cond_f
    ...
    .end local v17           #msg:Landroid/telephony/SmsMessage;
    .end local v18           #output:Ljava/io/ByteArrayOutputStream;
    .end local v21           #sca:Ljava/lang/String;
    :cond_12
    const/4 v2, 0x0
...
.method protected processMessagePart([BLjava/lang/String;IIIJIZ)I
    ...
    .line 1108
    .local v30, simId:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v30           #simId:Ljava/lang/String;
    :goto_0
    return v4
    ...
    .restart local v30       #simId:Ljava/lang/String;
    :cond_2
    :try_start_2
    invoke-interface {v11}, Landroid/database/Cursor;->close()V
    ...
    .line 1182
    const-string/jumbo v4, "recv_time"
    ...
    .line 1237
    .local v33, udh:Lcom/android/internal/telephony/SmsHeader;
    if-eqz v33, :cond_12
    ...
    .line 1238
    new-instance v32, Lcom/mediatek/common/sms/TimerRecord;
    ...
    .line 1240
    .local v32, tr:Lcom/mediatek/common/sms/TimerRecord;
    move-object/from16 v0, p0
    ...
    .line 1243
    .end local v32           #tr:Lcom/mediatek/common/sms/TimerRecord;
    .end local v33           #udh:Lcom/android/internal/telephony/SmsHeader;
    :cond_12
    const-string v4, "SMS"
    ...
    const-string/jumbo v6, "put address into bundle for CDMA: "
    ...
    invoke-virtual {v4, v15, v0}, Lcom/android/internal/telephony/WapPushOverSms;->dispatchWapPdu([BLandroid/os/Bundle;)I
    ...
    .line 1323
    .restart local v20       #mBundle:Landroid/os/Bundle;
    if-eqz v31, :cond_1d
    ...
    .line 1325
    invoke-virtual/range {v31 .. v31}, Landroid/telephony/SmsMessage;->getServiceCenterAddress()Ljava/lang/String;

    move-result-object v28

    .line 1326
    .local v28, sca:Ljava/lang/String;
    if-nez v28, :cond_1c
    ...
    .line 1332
    .end local v28           #sca:Ljava/lang/String;
    :cond_1d
    move-object/from16 v0, p0
    ...
    const-string/jumbo v5, "no user data header, dispatch pdus only"
