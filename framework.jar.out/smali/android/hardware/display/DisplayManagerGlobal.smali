...
.method public addVirtualDisplay(IIIIIII)I
    ...
    .line 197
    :try_start_0
    iget-object v9, p0, Landroid/hardware/display/DisplayManagerGlobal;->mLock:Ljava/lang/Object;
    ...
    invoke-interface/range {v0 .. v7}, Landroid/hardware/display/IDisplayManager;->addVirtualDisplay(IIIIIII)I
    ...
    const-string v1, "Could not add virtual display from display manager."
...
.method public assignDisplayMap(IIZ)V
    ...
    invoke-interface {v1, p1, p2, p3}, Landroid/hardware/display/IDisplayManager;->assignDisplayMap(IIZ)V
    ...
    const-string v2, "Could not assign display map from display manager."
...
.method public getDisplayHasContent(I)Z
    ...
    invoke-interface {v1, p1}, Landroid/hardware/display/IDisplayManager;->getDisplayHasContent(I)Z
    ...
    const-string v2, "Could not get hasContent for display."
...
.method public getParentForDisplay(I)I
    ...
    invoke-interface {v1, p1}, Landroid/hardware/display/IDisplayManager;->getParentForDisplay(I)I
    ...
    const-string v2, "Could not get parent for virtual display."
...
.method public getVirtualDisplayIds()[I
    ...
    invoke-interface {v2}, Landroid/hardware/display/IDisplayManager;->getVirtualDisplayIds()[I
    ...
    const-string v3, "Could not get virtual display ids from display manager."
...
.method public removeVirtualDisplay(I)V
    ...
    invoke-interface {v1, p1}, Landroid/hardware/display/IDisplayManager;->removeVirtualDisplay(I)V
    ...
    const-string v2, "Could not remove virtual display from display manager."
...
.method public setDefaultExternalDisplay(IZ)Z
    ...
    invoke-interface {v2, p1, p2}, Landroid/hardware/display/IDisplayManager;->setDefaultExternalDisplay(IZ)Z
    ...
    const-string v3, "Could not set default external display."
...
.method public setVirtualDisplayFocus(IZ)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/hardware/display/IDisplayManager;->setVirtualDisplayFocus(IZ)Z
    ...
    const-string v2, "Could not set focus for virtual display."
...
.method public updateVirtualDisplay(IIIII)V
    ...
    invoke-interface/range {v0 .. v5}, Landroid/hardware/display/IDisplayManager;->updateVirtualDisplay(IIIII)V
    ...
    const-string v1, "Could not update virtual display from display manager."
