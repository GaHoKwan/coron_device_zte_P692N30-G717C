...
.field private static SDUPDATE_DIR:Ljava/io/File; = null

.field private static SDUPDATE_FILE:Ljava/io/File; = null
...
.method static constructor <clinit>()V
    ...
    const-string v1, "/cache/sd"

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    sput-object v0, Landroid/os/RecoverySystem;->SDUPDATE_DIR:Ljava/io/File;

    .line 88
    new-instance v0, Ljava/io/File;

    sget-object v1, Landroid/os/RecoverySystem;->SDUPDATE_DIR:Ljava/io/File;

    const-string v2, "data_type"

    invoke-direct {v0, v1, v2}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    sput-object v0, Landroid/os/RecoverySystem;->SDUPDATE_FILE:Ljava/io/File;
...
.method public static installPackage(Landroid/content/Context;Ljava/io/File;)V
    ...
    const-string v4, "Must start with /cache, /data, /storage/sdcard0, /storage/sdcard1 : "
...
.method public static installPackage(Landroid/content/Context;Ljava/io/File;Z)V
    ...
    .prologue
    .line 332
    invoke-static {p2}, Landroid/os/RecoverySystem;->sdUpdateBackUp(Z)V
...
.method public static sdUpdateBackUp(Z)V
    .locals 4
    .parameter "backup"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 338
    sget-object v1, Landroid/os/RecoverySystem;->SDUPDATE_FILE:Ljava/io/File;
    ...
    .line 341
    .local v0, sdupdate:Ljava/io/FileWriter;
    :try_start_0
    const-string v1, "RecoverySystem"
    ...
    const-string/jumbo v3, "sdUpdateBackUp"
