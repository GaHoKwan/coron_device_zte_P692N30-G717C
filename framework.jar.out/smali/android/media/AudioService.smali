...
.field protected static final DEBUG_AF:Z = false
...
.field private static final MSG_SMARTSHOW_SWITCH:I = 0x28
...
.field private final mExtFocusStack:Ljava/util/Stack;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Stack",
            "<",
...
.field private mSeparatedAudioFocus:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v2, v0, Landroid/media/AudioService;->mSeparatedAudioFocus:Z
    ...
    iput-object v2, v0, Landroid/media/AudioService;->mExtFocusStack:Ljava/util/Stack;
    ...
    iput-object v2, v0, Landroid/media/AudioService;->mStacks:Ljava/util/ArrayList;
    ...
    .line 619
    .local v15, pkgFilter:Landroid/content/IntentFilter;
    ...
    .line 632
    .local v17, t:Lcom/android/internal/telephony/ITelephony;
    if-eqz v17, :cond_8
    ...
    .line 633
    .local v14, notifyNow:Ljava/lang/Boolean;
    ...
    .line 634
    .local v18, tr:Lcom/android/internal/telephony/ITelephonyRegistry;
    const-string v2, "AudioService"
    ...
    .line 636
    .local v19, tr2:Lcom/android/internal/telephony/ITelephonyRegistry;
    const-string v2, "AudioService"
    ...
    .line 640
    .local v20, tr3:Lcom/android/internal/telephony/ITelephonyRegistry;
    const-string v2, "AudioService"
    ...
    .line 642
    .end local v20           #tr3:Lcom/android/internal/telephony/ITelephonyRegistry;
    :cond_2
    sget v2, Lcom/android/internal/telephony/PhoneConstants;->GEMINI_SIM_NUM:I
    ...
    .line 645
    .local v21, tr4:Lcom/android/internal/telephony/ITelephonyRegistry;
    const-string v2, "AudioService"
    ...
    .line 654
    .end local v14           #notifyNow:Ljava/lang/Boolean;
    .end local v17           #t:Lcom/android/internal/telephony/ITelephony;
    .end local v18           #tr:Lcom/android/internal/telephony/ITelephonyRegistry;
    .end local v19           #tr2:Lcom/android/internal/telephony/ITelephonyRegistry;
    .end local v21           #tr4:Lcom/android/internal/telephony/ITelephonyRegistry;
    :cond_3
    :goto_4
    invoke-virtual/range {p1 .. p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v2, v0, Landroid/media/AudioService;->mStacks:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Landroid/media/AudioService;->mFocusStack:Ljava/util/Stack;
    ...
    iget-object v3, v0, Landroid/media/AudioService;->mExtFocusStack:Ljava/util/Stack;

    invoke-virtual {v2, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 673
    :cond_4
    const-string/jumbo v2, "persist.smartshow.focusnotsep"
    ...
    .line 674
    .local v12, focusNotSeparated:Ljava/lang/String;
    if-eqz v12, :cond_5
    ...
    .end local v12           #focusNotSeparated:Ljava/lang/String;
    .end local v13           #intentFilter:Landroid/content/IntentFilter;
    .end local v15           #pkgFilter:Landroid/content/IntentFilter;
    :cond_6
    ...
    .restart local v15       #pkgFilter:Landroid/content/IntentFilter;
    .restart local v17       #t:Lcom/android/internal/telephony/ITelephony;
    :cond_8
    const/4 v2, 0x0
...
.method static synthetic access$10002(Landroid/media/AudioService;Landroid/media/IRemoteControlDisplay;)Landroid/media/IRemoteControlDisplay;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7500(Landroid/media/AudioService;IILjava/lang/String;)V
    ...
    .prologue
    .line 109
    invoke-direct {p0, p1, p2, p3}, Landroid/media/AudioService;->onSmartShowSwitch(IILjava/lang/String;)V
...
.method static synthetic access$8300(Landroid/media/AudioService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$8600(Landroid/media/AudioService;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$8700(Landroid/media/AudioService;Landroid/content/Context;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$9000(Landroid/media/AudioService;)Landroid/media/AudioManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9500(Landroid/media/AudioService;Landroid/os/IBinder;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$9900(Landroid/media/AudioService;)Ljava/util/Stack;
    .locals 1
    .parameter "x0"
...
.method private checkRingStreamVolumes()V
    .locals 5
    ...
    invoke-virtual {v2, v3}, Landroid/media/AudioService$VolumeStreamState;->applyRingIndexes(Z)V
...
.method private discardAudioFocusOwner()V
    ...
    .line 4641
    :try_start_0
    iget-object v5, p0, Landroid/media/AudioService;->mStacks:Ljava/util/ArrayList;
    ...
    .line 4644
    .local v3, focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    ...
    iget-object v5, v5, Landroid/media/AudioService$FocusStackEntry;->mFocusDispatcher:Landroid/media/IAudioFocusDispatcher;
    ...
    .line 4648
    .local v2, focusOwner:Landroid/media/AudioService$FocusStackEntry;
    :try_start_1
    iget-object v5, v2, Landroid/media/AudioService$FocusStackEntry;->mFocusDispatcher:Landroid/media/IAudioFocusDispatcher;

    const/4 v7, -0x1

    iget-object v8, v2, Landroid/media/AudioService$FocusStackEntry;->mClientId:Ljava/lang/String;

    invoke-interface {v5, v7, v8}, Landroid/media/IAudioFocusDispatcher;->dispatchAudioFocusChange(ILjava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :goto_1
    :try_start_2
    invoke-virtual {v2}, Landroid/media/AudioService$FocusStackEntry;->unlinkToDeath()V
    ...
    .line 4661
    .end local v2           #focusOwner:Landroid/media/AudioService$FocusStackEntry;
    :cond_0
    :try_start_4
    iget-boolean v5, p0, Landroid/media/AudioService;->mSeparatedAudioFocus:Z

    if-nez v5, :cond_2

    .line 4665
    .end local v3           #focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_1
    monitor-exit v6
    ...
    .line 4650
    .restart local v2       #focusOwner:Landroid/media/AudioService$FocusStackEntry;
    .restart local v3       #focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :catch_0
    move-exception v1
    ...
    const-string v8, "Failure to signal loss of audio focus due to "
...
.method private dispatchMediaKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    .line 5080
    .local v18, identToken:J
    move-object/from16 v0, p0

    iget-object v1, v0, Landroid/media/AudioService;->mActivityManager:Landroid/app/ActivityManager;
    ...
    iget-object v0, v0, Landroid/media/AudioService;->mRCStack:Ljava/util/Stack;
    ...
    .line 5098
    .local v20, peakRcse:Landroid/media/AudioService$RemoteControlStackEntry;
    :try_start_3
    move-object/from16 v0, p0
    ...
    .line 5099
    .local v22, stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$RemoteControlStackEntry;>;"
    :cond_3
    :goto_2
    ...
    check-cast v21, Landroid/media/AudioService$RemoteControlStackEntry;

    .line 5101
    .local v21, rcse:Landroid/media/AudioService$RemoteControlStackEntry;
    move-object/from16 v0, v21

    iget-object v1, v0, Landroid/media/AudioService$RemoteControlStackEntry;->mMediaIntent:Landroid/app/PendingIntent;
    ...
    .line 5107
    .end local v12           #ID:I
    .end local v21           #rcse:Landroid/media/AudioService$RemoteControlStackEntry;
    :cond_4
    if-eqz v20, :cond_6
    ...
    .line 5126
    .end local v20           #peakRcse:Landroid/media/AudioService$RemoteControlStackEntry;
    .end local v22           #stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$RemoteControlStackEntry;>;"
    :catch_0
    move-exception v13
    ...
    .line 5108
    .restart local v20       #peakRcse:Landroid/media/AudioService$RemoteControlStackEntry;
    .restart local v22       #stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$RemoteControlStackEntry;>;"
    :cond_5
    const/4 v3, 0x0
...
.method private dumpFocusStack(Ljava/io/PrintWriter;)V
    ...
    .line 4762
    .local v1, focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    new-instance v5, Ljava/lang/StringBuilder;
    ...
    .line 4764
    .local v4, stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    :goto_1
    ...
    iget-object v7, v2, Landroid/media/AudioService$FocusStackEntry;->mSourceRef:Landroid/os/IBinder;
    ...
    iget-object v7, v2, Landroid/media/AudioService$FocusStackEntry;->mPackageName:Ljava/lang/String;
    ...
    iget-object v7, v2, Landroid/media/AudioService$FocusStackEntry;->mClientId:Ljava/lang/String;
    ...
    iget v7, v2, Landroid/media/AudioService$FocusStackEntry;->mFocusChangeType:I
    ...
    iget v7, v2, Landroid/media/AudioService$FocusStackEntry;->mCallingUid:I
    ...
    iget v7, v2, Landroid/media/AudioService$FocusStackEntry;->mStreamType:I
    ...
    iget v7, v2, Landroid/media/AudioService$FocusStackEntry;->mContextId:I
    ...
    iget v7, v2, Landroid/media/AudioService$FocusStackEntry;->mTaskId:I
    ...
    .line 4776
    .end local v0           #N:I
    .end local v1           #focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    .end local v2           #fse:Landroid/media/AudioService$FocusStackEntry;
    .end local v3           #i:I
    .end local v4           #stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    :catchall_0
    move-exception v5
    ...
    .line 4760
    .restart local v0       #N:I
    .restart local v1       #focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    .restart local v3       #i:I
    .restart local v4       #stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_0
    add-int/lit8 v3, v3, 0x1
...
.method private enforceSafeMediaVolume(I)V
    ...
    .end local v15           #devices:I
    .end local v17           #i:I
    .end local v19           #lastAudible:Z
    :cond_0
    const/16 v19, 0x0
    ...
    .restart local v15       #devices:I
    .restart local v16       #i:I
    .restart local v19       #lastAudible:Z
    :cond_1
    move/from16 v0, v19

    invoke-virtual {v7, v6, v0}, Landroid/media/AudioService$VolumeStreamState;->getIndex(IZ)I
    ...
    .line 6752
    .local v20, safeMediaVolumeIndex:I
    move/from16 v0, v18
    ...
    invoke-virtual {v7, v0, v6}, Landroid/media/AudioService$VolumeStreamState;->setLastAudibleIndex(II)V
    ...
    invoke-virtual {v7, v0, v6, v2}, Landroid/media/AudioService$VolumeStreamState;->setIndex(IIZ)Z
    ...
    .end local v20           #safeMediaVolumeIndex:I
    .restart local v17       #i:I
    :cond_4
    return-void
.end method
...
.method private moveAudioFocus(Ljava/lang/String;I)V
    .locals 22
    .parameter "ids"
    .parameter "state"
    ...
    .prologue
    .line 4245
    sget-object v19, Landroid/media/AudioService;->mAudioFocusLock:Ljava/lang/Object;
    ...
    .line 4247
    .local v10, idsArray:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    const/4 v11, 0x0

    .line 4249
    .local v11, isAllMoved:Z
    const-string v18, ","
    ...
    iget-object v13, v0, Landroid/media/AudioService;->mFocusStack:Ljava/util/Stack;

    .line 4255
    .local v13, srcStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :goto_1
    const/16 v18, 0x1
    ...
    iget-object v4, v0, Landroid/media/AudioService;->mExtFocusStack:Ljava/util/Stack;

    .line 4256
    .local v4, dstStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :goto_2
    const/16 v18, 0x1
    ...
    .line 4257
    .local v15, switchBack:Z
    :goto_3
    const/4 v5, 0x0

    .line 4258
    .local v5, dstTopFocus:Landroid/media/AudioService$FocusStackEntry;
    ...
    check-cast v18, Landroid/media/AudioService$FocusStackEntry;
    ...
    .end local v5           #dstTopFocus:Landroid/media/AudioService$FocusStackEntry;
    check-cast v5, Landroid/media/AudioService$FocusStackEntry;

    .line 4262
    .restart local v5       #dstTopFocus:Landroid/media/AudioService$FocusStackEntry;
    :cond_1
    ...
    .line 4277
    .local v17, topOfSrcStackMoved:Z
    ...
    iget v0, v0, Landroid/media/AudioService$FocusStackEntry;->mTaskId:I
    ...
    invoke-interface {v0, v1, v2}, Landroid/media/IAudioFocusDispatcher;->dispatchAudioFocusChange(ILjava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 4295
    .local v14, stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_5
    :goto_5
    ...
    check-cast v8, Landroid/media/AudioService$FocusStackEntry;

    .line 4297
    .local v8, fse:Landroid/media/AudioService$FocusStackEntry;
    if-nez v11, :cond_6

    iget v0, v8, Landroid/media/AudioService$FocusStackEntry;->mTaskId:I
    ...
    .line 4298
    :cond_6
    const-string v18, "AudioService"

    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v21, "removing entry for "

    invoke-virtual/range {v20 .. v21}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v20

    iget-object v0, v8, Landroid/media/AudioService$FocusStackEntry;->mClientId:Ljava/lang/String;
    ...
    invoke-virtual {v4, v0, v8}, Ljava/util/Stack;->add(ILjava/lang/Object;)V
    ...
    .line 4254
    .end local v4           #dstStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    .end local v5           #dstTopFocus:Landroid/media/AudioService$FocusStackEntry;
    .end local v7           #focusMoved:Z
    .end local v8           #fse:Landroid/media/AudioService$FocusStackEntry;
    .end local v13           #srcStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    .end local v14           #stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    .end local v15           #switchBack:Z
    .end local v17           #topOfSrcStackMoved:Z
    :cond_7
    move-object/from16 v0, p0

    iget-object v13, v0, Landroid/media/AudioService;->mExtFocusStack:Ljava/util/Stack;

    goto/16 :goto_1

    .line 4255
    .restart local v13       #srcStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_8
    move-object/from16 v0, p0

    iget-object v4, v0, Landroid/media/AudioService;->mFocusStack:Ljava/util/Stack;

    goto/16 :goto_2

    .line 4256
    .restart local v4       #dstStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_9
    const/4 v15, 0x1
    ...
    .line 4287
    .restart local v5       #dstTopFocus:Landroid/media/AudioService$FocusStackEntry;
    .restart local v15       #switchBack:Z
    .restart local v17       #topOfSrcStackMoved:Z
    :catch_0
    move-exception v6
    ...
    const-string v21, "Failure to signal loss of audio focus due to "
    ...
    .end local v9           #i$:I
    .end local v10           #idsArray:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    .end local v11           #isAllMoved:Z
    .end local v12           #len$:I
    .end local v13           #srcStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    .end local v15           #switchBack:Z
    .end local v17           #topOfSrcStackMoved:Z
    ...
    .restart local v4       #dstStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    .restart local v5       #dstTopFocus:Landroid/media/AudioService$FocusStackEntry;
    .restart local v7       #focusMoved:Z
    .restart local v8       #fse:Landroid/media/AudioService$FocusStackEntry;
    .restart local v9       #i$:I
    .restart local v10       #idsArray:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    .restart local v11       #isAllMoved:Z
    .restart local v12       #len$:I
    .restart local v13       #srcStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    .restart local v14       #stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    .restart local v15       #switchBack:Z
    .restart local v17       #topOfSrcStackMoved:Z
    :cond_a
    :try_start_3
    ...
    .line 4323
    :try_start_5
    iget-object v0, v5, Landroid/media/AudioService$FocusStackEntry;->mFocusDispatcher:Landroid/media/IAudioFocusDispatcher;

    move-object/from16 v18, v0

    const/16 v20, -0x1

    iget-object v0, v5, Landroid/media/AudioService$FocusStackEntry;->mClientId:Ljava/lang/String;
    ...
    .line 4345
    :try_start_9
    invoke-direct/range {p0 .. p0}, Landroid/media/AudioService;->clearRemoteControlDisplay_syncAfRcs()V
    ...
    const-string v21, "Failure to signal gain of audio focus due to "
...
.method private notifyTopOfAudioFocusStack(Z)V
    .locals 5
    .parameter "onLocal"
    ...
    iget-object v3, v2, Landroid/media/AudioService$FocusStackEntry;->mFocusDispatcher:Landroid/media/IAudioFocusDispatcher;
    ...
    invoke-interface {v3, v4, v2}, Landroid/media/IAudioFocusDispatcher;->dispatchAudioFocusChange(ILjava/lang/String;)V
    ...
    const-string/jumbo v4, "notifyTopOfAudioFocusStack: clientId = "
    ...
    .end local v1           #focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_1
    iget-object v1, p0, Landroid/media/AudioService;->mExtFocusStack:Ljava/util/Stack;
...
.method private onCheckMusicActive()V
    ...
    invoke-virtual {v0, v8, v1}, Landroid/media/AudioService$VolumeStreamState;->getIndex(IZ)I
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    .line 4159
    :try_start_0
    invoke-static {p1, p2, p3}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;)I
    ...
    .line 4199
    invoke-direct {p0}, Landroid/media/AudioService;->checkRingStreamVolumes()V
...
.method private onSmartShowSwitch(IILjava/lang/String;)V
    .locals 1
    .parameter "device"
    .parameter "state"
    .parameter "name"
...
.method private removeFocusStackEntry(Ljava/lang/String;Z)V
    ...
    .prologue
    .line 4789
    iget-object v6, p0, Landroid/media/AudioService;->mStacks:Ljava/util/ArrayList;
    ...
    check-cast v6, Landroid/media/AudioService$FocusStackEntry;

    iget-object v6, v6, Landroid/media/AudioService$FocusStackEntry;->mClientId:Ljava/lang/String;
    ...
    :goto_1
    invoke-direct {p0, v6}, Landroid/media/AudioService;->notifyTopOfAudioFocusStack(Z)V
    ...
    .line 4811
    .local v5, stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_3
    :goto_2
    ...
    .line 4813
    .restart local v2       #fse:Landroid/media/AudioService$FocusStackEntry;
    iget-object v6, v2, Landroid/media/AudioService$FocusStackEntry;->mClientId:Ljava/lang/String;
    ...
    const-string v8, " AudioFocus  abandonAudioFocus(): removing entry for "
...
.method private removeFocusStackEntryForClient(Landroid/os/IBinder;)V
    ...
    .line 4836
    iget-object v7, p0, Landroid/media/AudioService;->mStacks:Ljava/util/ArrayList;
    ...
    check-cast v7, Landroid/media/AudioService$FocusStackEntry;

    iget-object v7, v7, Landroid/media/AudioService$FocusStackEntry;->mSourceRef:Landroid/os/IBinder;
    ...
    .line 4841
    .local v5, isTopOfStackForClientToRemove:Z
    :goto_1
    const/4 v4, 0x0
    ...
    .line 4843
    .local v6, stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_0
    :goto_2
    ...
    const-string v11, " AudioFocus  abandonAudioFocus(): removing entry for "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, v2, Landroid/media/AudioService$FocusStackEntry;->mClientId:Ljava/lang/String;
    ...
    .end local v5           #isTopOfStackForClientToRemove:Z
    .end local v6           #stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_1
    move v5, v9
    ...
    .restart local v5       #isTopOfStackForClientToRemove:Z
    .restart local v6       #stackIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_2
    if-eqz v5, :cond_5
    ...
    :goto_3
    invoke-direct {p0, v8}, Landroid/media/AudioService;->notifyTopOfAudioFocusStack(Z)V
    ...
    :try_start_0
    invoke-direct {p0, v7}, Landroid/media/AudioService;->checkUpdateRemoteControlDisplay_syncAfRcs(I)V
...
.method private updateStreamVolumeAlias(Z)V
    ...
    invoke-virtual {v0, v3}, Landroid/media/AudioService$VolumeStreamState;->applyRingIndexes(Z)V
    ...
    invoke-virtual {v0, v4}, Landroid/media/AudioService$VolumeStreamState;->applyRingIndexes(Z)V
...
.method public requestAudioFocus(IILandroid/os/IBinder;Landroid/media/IAudioFocusDispatcher;Ljava/lang/String;Ljava/lang/String;IIZ)I
    .locals 17
    ...
    iget-object v14, v0, Landroid/media/AudioService;->mExtFocusStack:Ljava/util/Stack;

    .line 4918
    .local v14, focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :goto_0
    ...
    .line 4914
    .end local v14           #focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_0
    move-object/from16 v0, p0

    iget-object v14, v0, Landroid/media/AudioService;->mFocusStack:Ljava/util/Stack;

    goto :goto_0

    .line 4923
    .restart local v14       #focusStack:Ljava/util/Stack;,"Ljava/util/Stack<Landroid/media/AudioService$FocusStackEntry;>;"
    :cond_1
    ...
    const-string v3, "Can not Reassign AudioFocus"
    ...
    :cond_2
    :try_start_1
    new-instance v8, Landroid/media/AudioService$AudioFocusDeathHandler;

    move-object/from16 v0, p0

    move-object/from16 v1, p3

    invoke-direct {v8, v0, v1}, Landroid/media/AudioService$AudioFocusDeathHandler;-><init>(Landroid/media/AudioService;Landroid/os/IBinder;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 4934
    .local v8, afdh:Landroid/media/AudioService$AudioFocusDeathHandler;
    const/4 v2, 0x0
    ...
    iget v2, v2, Landroid/media/AudioService$FocusStackEntry;->mFocusChangeType:I
    ...
    check-cast v15, Landroid/media/AudioService$FocusStackEntry;

    .line 4953
    .local v15, fse:Landroid/media/AudioService$FocusStackEntry;
    invoke-virtual {v15}, Landroid/media/AudioService$FocusStackEntry;->unlinkToDeath()V

    .line 4957
    .end local v15           #fse:Landroid/media/AudioService$FocusStackEntry;
    :cond_4
    invoke-virtual {v14}, Ljava/util/Stack;->empty()Z
    ...
    .line 4972
    new-instance v2, Landroid/media/AudioService$FocusStackEntry;
    ...
    invoke-direct/range {v2 .. v12}, Landroid/media/AudioService$FocusStackEntry;-><init>(IILandroid/media/IAudioFocusDispatcher;Landroid/os/IBinder;Ljava/lang/String;Landroid/media/AudioService$AudioFocusDeathHandler;Ljava/lang/String;III)V
    ...
    invoke-direct {v0, v2}, Landroid/media/AudioService;->checkUpdateRemoteControlDisplay_syncAfRcs(I)V
    ...
    const-string v4, " Failure to signal loss of focus due to "
...
.method public setWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    .line 2927
    :try_start_0
    iget-boolean v0, p0, Landroid/media/AudioService;->mSeparatedAudioFocus:Z
