...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 338
    iget v4, p0, Landroid/net/wifi/WifiInfo;->mNetworkId:I

    invoke-virtual {p1, v4}, Landroid/os/Parcel;->writeInt(I)V

    .line 339
    iget v4, p0, Landroid/net/wifi/WifiInfo;->mRssi:I

    invoke-virtual {p1, v4}, Landroid/os/Parcel;->writeInt(I)V

    .line 340
    iget v4, p0, Landroid/net/wifi/WifiInfo;->mLinkSpeed:I
    ...
    .line 350
    :goto_0
    iget-object v1, p0, Landroid/net/wifi/WifiInfo;->mIpV6Address:Ljava/net/InetAddress;

    .line 351
    .local v1, ia6:Ljava/net/InetAddress;
    if-eqz v1, :cond_1
    ...
    .line 359
    :goto_1
    iget-object v4, p0, Landroid/net/wifi/WifiInfo;->mWifiSsid:Landroid/net/wifi/WifiSsid;
    ...
    .line 365
    :goto_2
    iget-object v4, p0, Landroid/net/wifi/WifiInfo;->mBSSID:Ljava/lang/String;

    invoke-virtual {p1, v4}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 366
    iget-object v4, p0, Landroid/net/wifi/WifiInfo;->mMacAddress:Ljava/lang/String;

    invoke-virtual {p1, v4}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 367
    iget-boolean v4, p0, Landroid/net/wifi/WifiInfo;->mMeteredHint:Z
    ...
    .line 347
    .end local v1           #ia6:Ljava/net/InetAddress;
    :cond_0
    ...
    .line 355
    .restart local v1       #ia6:Ljava/net/InetAddress;
    :cond_1
    invoke-virtual {p1, v3}, Landroid/os/Parcel;->writeByte(B)V
