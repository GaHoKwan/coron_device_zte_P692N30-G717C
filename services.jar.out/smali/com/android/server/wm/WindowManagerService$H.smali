...
.field public static final DO_REFRESH:I = 0x3e8
...
.method private handleFocusChangedForDisplayContent(Lcom/android/server/wm/DisplayContent;)V
    .locals 5
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/WindowManagerService;->hasEnableMultiWindow()Z
    ...
    .line 8965
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/server/wm/WindowManagerService$H;->handleSpecialFocusChangedInner(Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/wm/WindowManagerService$H;->handleFocusChangedInner(I)V
...
.method private handleFocusChangedInner(I)V
    .locals 6
    .parameter "displayId"
    ...
    .line 9031
    :cond_1
    invoke-virtual {v0, p1}, Lcom/android/server/wm/DisplayContent;->getLastFocus(I)Lcom/android/server/wm/WindowState;
    ...
    .restart local v1       #lastFocus:Lcom/android/server/wm/WindowState;
    .restart local v2       #newFocus:Lcom/android/server/wm/WindowState;
    :cond_2
    :try_start_1
    invoke-virtual {v0, p1, v2}, Lcom/android/server/wm/DisplayContent;->saveLastFocus(ILcom/android/server/wm/WindowState;)V
    ...
    iget-object v3, v3, Lcom/android/server/wm/WindowManagerService;->mLosingFocus:Ljava/util/ArrayList;
    ...
    invoke-interface {v3, v4, v5}, Landroid/view/IWindow;->windowFocusChanged(ZZ)V
    :try_end_2
    ...
    invoke-static {v3}, Lcom/android/server/wm/WindowManagerService;->access$400(Lcom/android/server/wm/WindowManagerService;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 9080
    :sswitch_0
    new-instance v19, Lcom/android/server/wm/WindowManagerService$DisplayContentsIterator;
    ...
    invoke-direct {v0, v2}, Lcom/android/server/wm/WindowManagerService$DisplayContentsIterator;-><init>(Lcom/android/server/wm/WindowManagerService;)V

    .line 9081
    .local v19, iterator:Lcom/android/server/wm/WindowManagerService$DisplayContentsIterator;
    :goto_2
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wm/WindowManagerService$DisplayContentsIterator;->hasNext()Z
    ...
    .line 9082
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wm/WindowManagerService$DisplayContentsIterator;->next()Lcom/android/server/wm/DisplayContent;
    ...
    invoke-direct {v0, v13}, Lcom/android/server/wm/WindowManagerService$H;->handleFocusChangedForDisplayContent(Lcom/android/server/wm/DisplayContent;)V

    goto :goto_2

    .line 9090
    .end local v13           #displayContent:Lcom/android/server/wm/DisplayContent;
    .end local v19           #iterator:Lcom/android/server/wm/WindowManagerService$DisplayContentsIterator;
    :sswitch_1
    move-object/from16 v0, p0
    ...
    invoke-virtual {v2, v4}, Lcom/android/server/wm/WindowManagerService;->refreshScreenLocked(I)V
    ...
    iget-object v2, v2, Lcom/android/server/wm/WindowManagerService;->mDisplayManager:Landroid/hardware/display/DisplayManager;

    move-object/from16 v0, p1

    iget v3, v0, Landroid/os/Message;->arg1:I

    invoke-virtual {v2, v3}, Landroid/hardware/display/DisplayManager;->getParentForDisplay(I)I

    move-result v25

    .line 9539
    .local v25, parentDisplayId:I
    if-ltz v25, :cond_1
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/WindowManagerService;->getInputMonitor()Lcom/android/server/wm/InputMonitor;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/server/wm/InputMonitor;->updateFakeWindowsInfoLw()V
    ...
    iget-object v2, v2, Lcom/android/server/wm/WindowManagerService;->mSmartShowContext:Lcom/android/server/FullSmartShowContext;

    invoke-virtual {v2}, Lcom/android/server/FullSmartShowContext;->updateFocusedDisplayId()V

    goto/16 :goto_0

    .line 9536
    .end local v25           #parentDisplayId:I
    :catchall_12
    move-exception v2
...
.method handleSpecialFocusChangedInner(Lcom/android/server/wm/DisplayContent;)V
    .locals 6
    .parameter "displayContent"
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/WindowManagerService;->hasEnableMultiWindow()Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/DisplayContent;->getLastFocus(I)Lcom/android/server/wm/WindowState;

    move-result-object v1

    .line 8982
    .local v1, lastFocus:Lcom/android/server/wm/WindowState;
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->getCurrentFocus()Lcom/android/server/wm/WindowState;
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p1, v0, v2}, Lcom/android/server/wm/DisplayContent;->saveLastFocus(ILcom/android/server/wm/WindowState;)V
