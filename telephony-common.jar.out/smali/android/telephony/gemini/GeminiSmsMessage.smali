...
.method public getSmsc()[B
    ...
    .prologue
    .line 182
    iget v1, p0, Landroid/telephony/gemini/GeminiSmsMessage;->simId:I

    invoke-static {v1}, Landroid/telephony/gemini/GeminiSmsManager;->getSmsFormat(I)Ljava/lang/String;

    move-result-object v0

    .line 183
    .local v0, format:Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/telephony/gemini/GeminiSmsMessage;->getSmsc(Ljava/lang/String;)[B
...
.method public getTpdu()[B
    ...
    .line 230
    .local v0, format:Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/telephony/gemini/GeminiSmsMessage;->getTpdu(Ljava/lang/String;)[B
