...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/musicvis/ScriptField_Vertex;->mElementCache:Ljava/lang/ref/WeakReference;
...
.method private copyToArray(Lcom/android/musicvis/ScriptField_Vertex$Item;I)V
    .locals 2
    .parameter "i"
    .parameter "index"
    ...
    .prologue
    .line 118
    iget-object v0, p0, Lcom/android/musicvis/ScriptField_Vertex;->mIOBuffer:Landroid/renderscript/FieldPacker;
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/musicvis/ScriptField_Vertex;->copyToArrayLocal(Lcom/android/musicvis/ScriptField_Vertex$Item;Landroid/renderscript/FieldPacker;)V

    .line 121
    return-void
.end method

.method private copyToArrayLocal(Lcom/android/musicvis/ScriptField_Vertex$Item;Landroid/renderscript/FieldPacker;)V
    .locals 1
    .parameter "i"
    .parameter "fp"
    ...
    .prologue
    .line 113
    iget-object v0, p1, Lcom/android/musicvis/ScriptField_Vertex$Item;->position:Landroid/renderscript/Float2;

    invoke-virtual {p2, v0}, Landroid/renderscript/FieldPacker;->addF32(Landroid/renderscript/Float2;)V

    .line 114
    iget-object v0, p1, Lcom/android/musicvis/ScriptField_Vertex$Item;->texture0:Landroid/renderscript/Float2;
...
.method public static create1D(Landroid/renderscript/RenderScript;I)Lcom/android/musicvis/ScriptField_Vertex;
    .locals 1
    .parameter "rs"
    .parameter "dimX"
    ...
    invoke-static {p0, p1, v0}, Lcom/android/musicvis/ScriptField_Vertex;->create1D(Landroid/renderscript/RenderScript;II)Lcom/android/musicvis/ScriptField_Vertex;
...
.method public static create1D(Landroid/renderscript/RenderScript;II)Lcom/android/musicvis/ScriptField_Vertex;
    .locals 2
    .parameter "rs"
    .parameter "dimX"
    .parameter "usages"
    ...
    .prologue
    .line 74
    new-instance v0, Lcom/android/musicvis/ScriptField_Vertex;

    invoke-direct {v0, p0}, Lcom/android/musicvis/ScriptField_Vertex;-><init>(Landroid/renderscript/RenderScript;)V

    .line 75
    .local v0, obj:Lcom/android/musicvis/ScriptField_Vertex;
...
.method public static create2D(Landroid/renderscript/RenderScript;II)Lcom/android/musicvis/ScriptField_Vertex;
    .locals 1
    .parameter "rs"
    .parameter "dimX"
    .parameter "dimY"
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/android/musicvis/ScriptField_Vertex;->create2D(Landroid/renderscript/RenderScript;III)Lcom/android/musicvis/ScriptField_Vertex;
...
.method public static create2D(Landroid/renderscript/RenderScript;III)Lcom/android/musicvis/ScriptField_Vertex;
    .locals 4
    .parameter "rs"
    .parameter "dimX"
    .parameter "dimY"
    ...
    .prologue
    .line 88
    new-instance v1, Lcom/android/musicvis/ScriptField_Vertex;

    invoke-direct {v1, p0}, Lcom/android/musicvis/ScriptField_Vertex;-><init>(Landroid/renderscript/RenderScript;)V

    .line 89
    .local v1, obj:Lcom/android/musicvis/ScriptField_Vertex;
...
.method public static createCustom(Landroid/renderscript/RenderScript;Landroid/renderscript/Type$Builder;I)Lcom/android/musicvis/ScriptField_Vertex;
    .locals 4
    .parameter "rs"
    .parameter "tb"
    .parameter "usages"
...
.method public static createTypeBuilder(Landroid/renderscript/RenderScript;)Landroid/renderscript/Type$Builder;
    ...
    .prologue
    .line 98
    invoke-static {p0}, Lcom/android/musicvis/ScriptField_Vertex;->createElement(Landroid/renderscript/RenderScript;)Landroid/renderscript/Element;
...
.method public declared-synchronized copyAll()V
    ...
    :goto_0
    :try_start_0
    iget-object v1, p0, Lcom/android/musicvis/ScriptField_Vertex;->mItemArray:[Lcom/android/musicvis/ScriptField_Vertex$Item;
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/musicvis/ScriptField_Vertex;->copyToArray(Lcom/android/musicvis/ScriptField_Vertex$Item;I)V
    ...
    iget-object v3, p0, Lcom/android/musicvis/ScriptField_Vertex;->mIOBuffer:Landroid/renderscript/FieldPacker;
...
.method public declared-synchronized get(I)Lcom/android/musicvis/ScriptField_Vertex$Item;
    .locals 1
    .parameter "index"
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/musicvis/ScriptField_Vertex;->mItemArray:[Lcom/android/musicvis/ScriptField_Vertex$Item;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized get_position(I)Landroid/renderscript/Float2;
    ...
    iget-object v0, v0, Lcom/android/musicvis/ScriptField_Vertex$Item;->position:Landroid/renderscript/Float2;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized get_texture0(I)Landroid/renderscript/Float2;
    ...
    iget-object v0, v0, Lcom/android/musicvis/ScriptField_Vertex$Item;->texture0:Landroid/renderscript/Float2;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized resize(I)V
    ...
    :try_start_0
    iget-object v3, p0, Lcom/android/musicvis/ScriptField_Vertex;->mItemArray:[Lcom/android/musicvis/ScriptField_Vertex$Item;
    ...
    :cond_1
    :try_start_1
    new-array v1, p1, [Lcom/android/musicvis/ScriptField_Vertex$Item;

    .line 191
    .local v1, ni:[Lcom/android/musicvis/ScriptField_Vertex$Item;
    iget-object v3, p0, Lcom/android/musicvis/ScriptField_Vertex;->mItemArray:[Lcom/android/musicvis/ScriptField_Vertex$Item;
    ...
    .line 192
    iput-object v1, p0, Lcom/android/musicvis/ScriptField_Vertex;->mItemArray:[Lcom/android/musicvis/ScriptField_Vertex$Item;

    .line 195
    .end local v0           #copySize:I
    .end local v1           #ni:[Lcom/android/musicvis/ScriptField_Vertex$Item;
    .end local v2           #oldSize:I
    :cond_2
    ...
    iput-object v3, p0, Lcom/android/musicvis/ScriptField_Vertex;->mIOBuffer:Landroid/renderscript/FieldPacker;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized set(Lcom/android/musicvis/ScriptField_Vertex$Item;IZ)V
    .locals 2
    .parameter "i"
    .parameter "index"
    .parameter "copyNow"
    ...
    new-array v1, v1, [Lcom/android/musicvis/ScriptField_Vertex$Item;
    ...
    .line 127
    invoke-direct {p0, p1, p2}, Lcom/android/musicvis/ScriptField_Vertex;->copyToArray(Lcom/android/musicvis/ScriptField_Vertex$Item;I)V
...
.method public declared-synchronized set_position(ILandroid/renderscript/Float2;Z)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/musicvis/ScriptField_Vertex;->mIOBuffer:Landroid/renderscript/FieldPacker;
    ...
    iput-object v1, p0, Lcom/android/musicvis/ScriptField_Vertex;->mIOBuffer:Landroid/renderscript/FieldPacker;
    ...
    new-instance v2, Lcom/android/musicvis/ScriptField_Vertex$Item;

    invoke-direct {v2}, Lcom/android/musicvis/ScriptField_Vertex$Item;-><init>()V
    ...
    iput-object p2, v1, Lcom/android/musicvis/ScriptField_Vertex$Item;->position:Landroid/renderscript/Float2;
...
.method public declared-synchronized set_texture0(ILandroid/renderscript/Float2;Z)V
    ...
    iput-object p2, v1, Lcom/android/musicvis/ScriptField_Vertex$Item;->texture0:Landroid/renderscript/Float2;
