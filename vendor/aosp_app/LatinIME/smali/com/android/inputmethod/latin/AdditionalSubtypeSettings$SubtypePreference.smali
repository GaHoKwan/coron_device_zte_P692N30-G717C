...
# static fields
.field private static final KEY_NEW_SUBTYPE:Ljava/lang/String; = "subtype_pref_new"

.field private static final KEY_PREFIX:Ljava/lang/String; = "subtype_pref_"
...
.method private static setSpinnerPosition(Landroid/widget/Spinner;Ljava/lang/Object;)V
    ...
    .line 255
    invoke-virtual {p0, v2}, Landroid/widget/AdapterView;->getItemAtPosition(I)Ljava/lang/Object;
    ...
    .line 257
    invoke-virtual {p0, v2}, Landroid/widget/AbsSpinner;->setSelection(I)V
...
.method public setSubtype(Landroid/view/inputmethod/InputMethodSubtype;)V
    ...
    invoke-virtual {p0, v1}, Landroid/preference/Preference;->setKey(Ljava/lang/String;)V
