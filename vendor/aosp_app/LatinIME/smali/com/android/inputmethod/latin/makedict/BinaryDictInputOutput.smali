...
.field private static final CHARACTER_BUFFER:[I = null

.field private static final DBG:Z = false

.field private static final MAX_JUMPS:I = 0xc

.field private static final MAX_PASSES:I = 0x18

.field private static final MSB16:I = 0x8000

.field private static final MSB24:I = 0x800000

.field private static final MSB8:I = 0x80

.field private static final SINT16_MAX:I = 0x7fff

.field private static final SINT24_MAX:I = 0x7fffff

.field private static final SINT8_MAX:I = 0x7f

.field private static final UINT16_MAX:I = 0xffff

.field private static final UINT24_MAX:I = 0xffffff
...
.method private static checkFlatNodeArray(Ljava/util/ArrayList;)V
    ...
    .prologue
    .line 662
    .local p0, array:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;>;"
    const/4 v3, 0x0
    ...
    check-cast v2, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;

    .line 665
    .local v2, n:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    iget v4, v2, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedAddress:I
    ...
    iget v6, v2, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedAddress:I
    ...
    .line 670
    iget v4, v2, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedSize:I
    ...
    .line 672
    .end local v2           #n:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    :cond_1
    return-void
.end method
...
.method static getWordAtAddress(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;IILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Ljava/lang/String;
    .locals 5
    .parameter "buffer"
    ...
    .prologue
    .line 1356
    sget-object v3, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->wordCache:Ljava/util/TreeMap;
    ...
    .line 1372
    .end local v0           #cachedString:Ljava/lang/String;
    :goto_0
    return-object v0

    .line 1360
    .restart local v0       #cachedString:Ljava/lang/String;
    :cond_0
    ...
    .line 1361
    .local v1, originalPointer:I
    invoke-interface {p0, p2}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;->position(I)V
    ...
    .line 1364
    invoke-static {p0, p1, p2, p3}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->getWordAtAddressWithParentAddress(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;IILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->getWordAtAddressWithoutParentAddress(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;IILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Ljava/lang/String;
...
.method private static getWordAtAddressWithParentAddress(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;IILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Ljava/lang/String;
    .locals 12
    .parameter "buffer"
    .parameter "headerSize"
    .parameter "address"
    ...
    .line 1388
    .local v7, loopCounter:I
    :cond_0
    add-int v8, v2, p1

    invoke-interface {p0, v8}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;->position(I)V

    .line 1389
    invoke-static {p0, v2, p3}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->readCharGroup(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;ILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Lcom/android/inputmethod/latin/makedict/CharGroupInfo;

    move-result-object v3

    .line 1390
    .local v3, currentInfo:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    iget v8, v3, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mFlags:I

    invoke-static {v8, p3}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->isMovedGroup(ILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Z
    ...
    .line 1391
    iget v8, v3, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mParentAddress:I

    iget v9, v3, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mOriginalAddress:I
    ...
    .local v4, i:I
    :goto_1
    iget-object v8, v3, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mCharacters:[I
    ...
    .line 1398
    sget-object v8, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->sGetWordBuffer:[I

    add-int/lit8 v6, v5, -0x1

    .end local v5           #index:I
    .local v6, index:I
    iget-object v9, v3, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mCharacters:[I

    iget-object v10, v3, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mCharacters:[I
    ...
    .line 1405
    .end local v3           #currentInfo:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    .end local v4           #i:I
    .end local v7           #loopCounter:I
    :cond_3
    new-instance v8, Ljava/lang/String;

    sget-object v9, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->sGetWordBuffer:[I
    ...
    .line 1402
    .restart local v3       #currentInfo:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    .restart local v4       #i:I
    .restart local v7       #loopCounter:I
    :cond_4
    iget v8, v3, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mParentAddress:I
...
.method private static getWordAtAddressWithoutParentAddress(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;IILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Ljava/lang/String;
    .locals 11
    .parameter "buffer"
    .parameter "headerSize"
    .parameter "address"
    ...
    .line 1413
    .local v1, count:I
    invoke-static {v1}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->getGroupCountSize(I)I
    ...
    .line 1418
    .local v5, last:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    ...
    .line 1420
    .local v4, info:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    iget v2, v4, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mEndAddress:I

    .line 1421
    iget v7, v4, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mOriginalAddress:I
    ...
    iget-object v8, v4, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mCharacters:[I

    iget-object v9, v4, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mCharacters:[I
    ...
    .line 1447
    .end local v4           #info:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    :cond_0
    return-object v6

    .line 1426
    .restart local v4       #info:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    :cond_1
    iget v7, v4, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mChildrenAddress:I

    invoke-static {v7}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->hasChildrenAddress(I)Z
    ...
    iget-object v8, v5, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mCharacters:[I

    iget-object v9, v5, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mCharacters:[I
    ...
    .line 1430
    iget v7, v5, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mChildrenAddress:I

    add-int/2addr v7, p1

    invoke-interface {p0, v7}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;->position(I)V
...
.method public static isBinaryDictionary(Ljava/lang/String;)Z
    ...
    .local v10, inStream:Ljava/io/FileInputStream;
    :try_start_1
    ...
    new-instance v0, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$ByteBufferWrapper;

    invoke-direct {v0, v6}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$ByteBufferWrapper;-><init>(Ljava/nio/ByteBuffer;)V

    invoke-static {v0}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->getFormatVersion(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;)I
    :try_end_1
    ...
    .end local v10           #inStream:Ljava/io/FileInputStream;
    .restart local v9       #inStream:Ljava/io/FileInputStream;
    move v13, v0
    ...
    .restart local v10       #inStream:Ljava/io/FileInputStream;
...
.method public static readDictionaryBinary(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;Lcom/android/inputmethod/latin/makedict/FusionDictionary;)Lcom/android/inputmethod/latin/makedict/FusionDictionary;
    .locals 13
    .parameter "buffer"
    .parameter "dict"
    .annotation system Ldalvik/annotation/Throws;
    ...
    .prologue
    .line 1625
    sget-object v9, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->wordCache:Ljava/util/TreeMap;
    ...
    .line 1631
    .local v6, reverseNodeMapping:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/Integer;Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;>;"
    new-instance v5, Ljava/util/TreeMap;

    invoke-direct {v5}, Ljava/util/TreeMap;-><init>()V

    .line 1632
    .local v5, reverseGroupMapping:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/Integer;Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;>;"
    iget v9, v1, Lcom/android/inputmethod/latin/makedict/FormatSpec$FileHeader;->mHeaderSize:I

    iget-object v10, v1, Lcom/android/inputmethod/latin/makedict/FormatSpec$FileHeader;->mFormatOptions:Lcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;

    invoke-static {p0, v9, v6, v5, v10}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->readNode(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;ILjava/util/Map;Ljava/util/Map;Lcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;

    move-result-object v7

    .line 1635
    .local v7, root:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    new-instance v4, Lcom/android/inputmethod/latin/makedict/FusionDictionary;

    iget-object v9, v1, Lcom/android/inputmethod/latin/makedict/FormatSpec$FileHeader;->mDictionaryOptions:Lcom/android/inputmethod/latin/makedict/FusionDictionary$DictionaryOptions;

    invoke-direct {v4, v7, v9}, Lcom/android/inputmethod/latin/makedict/FusionDictionary;-><init>(Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;Lcom/android/inputmethod/latin/makedict/FusionDictionary$DictionaryOptions;)V

    .line 1636
    .local v4, newDict:Lcom/android/inputmethod/latin/makedict/FusionDictionary;
    if-eqz p1, :cond_3

    .line 1637
    invoke-virtual {p1}, Lcom/android/inputmethod/latin/makedict/FusionDictionary;->iterator()Ljava/util/Iterator;
    ...
    check-cast v8, Lcom/android/inputmethod/latin/makedict/Word;

    .line 1638
    .local v8, w:Lcom/android/inputmethod/latin/makedict/Word;
    iget-boolean v9, v8, Lcom/android/inputmethod/latin/makedict/Word;->mIsBlacklistEntry:Z

    if-eqz v9, :cond_0

    .line 1639
    iget-object v9, v8, Lcom/android/inputmethod/latin/makedict/Word;->mWord:Ljava/lang/String;

    iget-object v10, v8, Lcom/android/inputmethod/latin/makedict/Word;->mShortcutTargets:Ljava/util/ArrayList;

    iget-boolean v11, v8, Lcom/android/inputmethod/latin/makedict/Word;->mIsNotAWord:Z

    invoke-virtual {v4, v9, v10, v11}, Lcom/android/inputmethod/latin/makedict/FusionDictionary;->addBlacklistEntry(Ljava/lang/String;Ljava/util/ArrayList;Z)V
    ...
    iget v10, v8, Lcom/android/inputmethod/latin/makedict/Word;->mFrequency:I

    iget-object v11, v8, Lcom/android/inputmethod/latin/makedict/Word;->mShortcutTargets:Ljava/util/ArrayList;

    iget-boolean v12, v8, Lcom/android/inputmethod/latin/makedict/Word;->mIsNotAWord:Z

    invoke-virtual {v4, v9, v10, v11, v12}, Lcom/android/inputmethod/latin/makedict/FusionDictionary;->add(Ljava/lang/String;ILjava/util/ArrayList;Z)V

    goto :goto_0

    .line 1644
    .end local v8           #w:Lcom/android/inputmethod/latin/makedict/Word;
    :cond_1
    invoke-virtual {p1}, Lcom/android/inputmethod/latin/makedict/FusionDictionary;->iterator()Ljava/util/Iterator;
    ...
    .line 1648
    .restart local v8       #w:Lcom/android/inputmethod/latin/makedict/Word;
    iget-object v9, v8, Lcom/android/inputmethod/latin/makedict/Word;->mBigrams:Ljava/util/ArrayList;
    ...
    iget-object v10, v0, Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;->mWord:Ljava/lang/String;

    iget v11, v0, Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;->mFrequency:I

    invoke-virtual {v4, v9, v10, v11}, Lcom/android/inputmethod/latin/makedict/FusionDictionary;->setBigram(Ljava/lang/String;Ljava/lang/String;I)V
...
.method private static readNode(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;ILjava/util/Map;Ljava/util/Map;Lcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    .locals 24
    .parameter "buffer"
    .parameter "headerSize"
    .parameter
    ...
    .prologue
    .line 1469
    .local p2, reverseNodeMap:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/Integer;Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;>;"
    .local p3, reverseGroupMap:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/Integer;Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;>;"
    new-instance v20, Ljava/util/ArrayList;

    invoke-direct/range {v20 .. v20}, Ljava/util/ArrayList;-><init>()V

    .line 1470
    .local v20, nodeContents:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;>;"
    invoke-interface/range {p0 .. p0}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;->position()I
    ...
    .line 1475
    .local v12, count:I
    invoke-static {v12}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->getGroupCountSize(I)I
    ...
    invoke-static {v0, v14, v1}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->readCharGroup(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;ILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Lcom/android/inputmethod/latin/makedict/CharGroupInfo;

    move-result-object v17

    .line 1478
    .local v17, info:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    move-object/from16 v0, v17

    iget v3, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mFlags:I

    move-object/from16 v0, p4

    invoke-static {v3, v0}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->isMovedGroup(ILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Z
    ...
    iget-object v5, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mShortcutTargets:Ljava/util/ArrayList;

    .line 1480
    .local v5, shortcutTargets:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;>;"
    const/4 v6, 0x0

    .line 1481
    .local v6, bigrams:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;>;"
    move-object/from16 v0, v17

    iget-object v3, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mBigrams:Ljava/util/ArrayList;
    ...
    .end local v6           #bigrams:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;>;"
    invoke-direct {v6}, Ljava/util/ArrayList;-><init>()V

    .line 1483
    .restart local v6       #bigrams:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;>;"
    move-object/from16 v0, v17
    ...
    check-cast v11, Lcom/android/inputmethod/latin/makedict/PendingAttribute;

    .line 1484
    .local v11, bigram:Lcom/android/inputmethod/latin/makedict/PendingAttribute;
    iget v3, v11, Lcom/android/inputmethod/latin/makedict/PendingAttribute;->mAddress:I
    ...
    invoke-static {v0, v1, v3, v2}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->getWordAtAddress(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;IILcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Ljava/lang/String;

    move-result-object v23

    .line 1486
    .local v23, word:Ljava/lang/String;
    new-instance v3, Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;

    iget v4, v11, Lcom/android/inputmethod/latin/makedict/PendingAttribute;->mFrequency:I

    move-object/from16 v0, v23

    invoke-direct {v3, v0, v4}, Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;-><init>(Ljava/lang/String;I)V
    ...
    .line 1489
    .end local v11           #bigram:Lcom/android/inputmethod/latin/makedict/PendingAttribute;
    .end local v16           #i$:Ljava/util/Iterator;
    .end local v23           #word:Ljava/lang/String;
    :cond_2
    move-object/from16 v0, v17

    iget v3, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mChildrenAddress:I

    invoke-static {v3}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->hasChildrenAddress(I)Z
    ...
    check-cast v10, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;

    .line 1491
    .local v10, children:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    if-nez v10, :cond_3
    ...
    invoke-interface {v0, v3}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;->position(I)V

    .line 1494
    invoke-static/range {p0 .. p4}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput;->readNode(Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;ILjava/util/Map;Ljava/util/Map;Lcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;)Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    ...
    invoke-interface {v0, v13}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;->position(I)V

    .line 1498
    .end local v13           #currentPosition:I
    :cond_3
    new-instance v3, Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;

    move-object/from16 v0, v17

    iget-object v4, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mCharacters:[I

    move-object/from16 v0, v17

    iget v7, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mFrequency:I

    move-object/from16 v0, v17

    iget v8, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mFlags:I
    ...
    iget v9, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mFlags:I
    ...
    :goto_4
    invoke-direct/range {v3 .. v10}, Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;-><init>([ILjava/util/ArrayList;Ljava/util/ArrayList;IZZLcom/android/inputmethod/latin/makedict/FusionDictionary$Node;)V
    ...
    .line 1510
    .end local v10           #children:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    :goto_5
    move-object/from16 v0, v17

    iget v14, v0, Lcom/android/inputmethod/latin/makedict/CharGroupInfo;->mEndAddress:I

    goto/16 :goto_1

    .line 1498
    .restart local v10       #children:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    :cond_4
    const/4 v8, 0x0
    ...
    :goto_7
    invoke-direct/range {v3 .. v9}, Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;-><init>([ILjava/util/ArrayList;Ljava/util/ArrayList;IZZ)V
    ...
    .line 1514
    .end local v5           #shortcutTargets:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;>;"
    .end local v6           #bigrams:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$WeightedString;>;"
    .end local v17           #info:Lcom/android/inputmethod/latin/makedict/CharGroupInfo;
    :cond_9
    move-object/from16 v0, p4

    iget-boolean v3, v0, Lcom/android/inputmethod/latin/makedict/FormatSpec$FormatOptions;->mSupportsDynamicUpdate:Z
    ...
    .line 1516
    .local v18, nextAddress:I
    if-ltz v18, :cond_b

    invoke-interface/range {p0 .. p0}, Lcom/android/inputmethod/latin/makedict/BinaryDictInputOutput$FusionDictionaryBufferInterface;->limit()I
    ...
    .line 1525
    :cond_b
    new-instance v19, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;

    invoke-direct/range {v19 .. v20}, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;-><init>(Ljava/util/ArrayList;)V

    .line 1526
    .local v19, node:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    move/from16 v0, v22

    move-object/from16 v1, v19

    iput v0, v1, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedAddress:I

    .line 1527
    move-object/from16 v0, v19

    iget v3, v0, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedAddress:I
...
.method private static showStatistics(Ljava/util/ArrayList;)V
    ...
    .prologue
    .line 1025
    .local p0, nodes:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;>;"
    const v2, 0x7fffffff
    ...
    .line 1032
    .local v10, n:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    iget-object v13, v10, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mData:Ljava/util/ArrayList;
    ...
    .line 1034
    .local v0, cg:Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;
    add-int/lit8 v1, v1, 0x1

    .line 1035
    iget-object v13, v0, Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;->mChars:[I
    ...
    .line 1036
    :cond_3
    iget v13, v0, Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;->mFrequency:I

    if-ltz v13, :cond_2

    .line 1037
    iget v13, v10, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedAddress:I

    if-ge v13, v2, :cond_4

    .line 1038
    iget v2, v10, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedAddress:I
    ...
    .line 1040
    iget v7, v10, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedAddress:I

    goto :goto_1

    .line 1043
    .end local v0           #cg:Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;
    :cond_5
    iget v13, v10, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedAddress:I

    iget v14, v10, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mCachedSize:I
    ...
    .line 1045
    .end local v6           #i$:Ljava/util/Iterator;
    .end local v10           #n:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    :cond_6
    ...
    .line 1048
    .restart local v10       #n:Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;
    iget-object v13, v10, Lcom/android/inputmethod/latin/makedict/FusionDictionary$Node;->mData:Ljava/util/ArrayList;
    ...
    .line 1050
    .restart local v0       #cg:Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;
    iget-object v13, v0, Lcom/android/inputmethod/latin/makedict/FusionDictionary$CharGroup;->mChars:[I
    ...
    invoke-static {v13}, Lcom/android/inputmethod/latin/makedict/MakedictLog;->i(Ljava/lang/String;)V
