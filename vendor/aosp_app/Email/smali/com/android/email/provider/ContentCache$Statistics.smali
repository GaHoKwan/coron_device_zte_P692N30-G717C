...
.method constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/email/provider/ContentCache$Statistics;->mCache:Lcom/android/email/provider/ContentCache;

    .line 796
    iput-object p1, p0, Lcom/android/email/provider/ContentCache$Statistics;->mName:Ljava/lang/String;
...
.method static synthetic access$1500(Lcom/android/email/provider/ContentCache$Statistics;Lcom/android/email/provider/ContentCache;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 761
    invoke-direct {p0, p1}, Lcom/android/email/provider/ContentCache$Statistics;->addCacheStatistics(Lcom/android/email/provider/ContentCache;)V

    return-void
.end method

.method static synthetic access$1600(Lcom/android/email/provider/ContentCache$Statistics;)Ljava/lang/String;
    .locals 1
    .parameter "x0"

    .prologue
    .line 761
    iget-object v0, p0, Lcom/android/email/provider/ContentCache$Statistics;->mName:Ljava/lang/String;
...
.method static synthetic access$800(Lcom/android/email/provider/ContentCache$Statistics;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 761
    iget v0, p0, Lcom/android/email/provider/ContentCache$Statistics;->mOpCount:I

    return v0
.end method

.method static synthetic access$808(Lcom/android/email/provider/ContentCache$Statistics;)I
    .locals 2
    .parameter "x0"
    ...
    iput v1, p0, Lcom/android/email/provider/ContentCache$Statistics;->mOpCount:I
...
.method private addCacheStatistics(Lcom/android/email/provider/ContentCache;)V
    .locals 4
    .parameter "cache"
    ...
    #getter for: Lcom/android/email/provider/ContentCache;->mStats:Lcom/android/email/provider/ContentCache$Statistics;
    invoke-static {p1}, Lcom/android/email/provider/ContentCache;->access$1400(Lcom/android/email/provider/ContentCache;)Lcom/android/email/provider/ContentCache$Statistics;

    move-result-object v1

    iget v1, v1, Lcom/android/email/provider/ContentCache$Statistics;->mHitCount:I
    ...
    iget v1, v1, Lcom/android/email/provider/ContentCache$Statistics;->mMissCount:I
    ...
    iget v1, v1, Lcom/android/email/provider/ContentCache$Statistics;->mProjectionMissCount:I
    ...
    iget v1, v1, Lcom/android/email/provider/ContentCache$Statistics;->mStaleCount:I
    ...
    iget-wide v2, v2, Lcom/android/email/provider/ContentCache$Statistics;->hitTimes:J
    ...
    iget-wide v2, v2, Lcom/android/email/provider/ContentCache$Statistics;->missTimes:J
    ...
    iget-wide v2, v2, Lcom/android/email/provider/ContentCache$Statistics;->hits:J

    add-long/2addr v0, v2

    iput-wide v0, p0, Lcom/android/email/provider/ContentCache$Statistics;->hits:J
    ...
    iget-wide v2, v2, Lcom/android/email/provider/ContentCache$Statistics;->miss:J

    add-long/2addr v0, v2

    iput-wide v0, p0, Lcom/android/email/provider/ContentCache$Statistics;->miss:J

    .line 809
    iget v0, p0, Lcom/android/email/provider/ContentCache$Statistics;->mCursorCount:I

    invoke-virtual {p1}, Lcom/android/email/provider/ContentCache;->size()I
    ...
    .line 810
    iget v0, p0, Lcom/android/email/provider/ContentCache$Statistics;->mTokenCount:I

    iget-object v1, p1, Lcom/android/email/provider/ContentCache;->mTokenList:Lcom/android/email/provider/ContentCache$TokenList;
