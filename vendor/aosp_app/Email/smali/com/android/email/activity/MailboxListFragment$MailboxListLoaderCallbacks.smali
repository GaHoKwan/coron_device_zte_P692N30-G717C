...
.method public onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    invoke-virtual {v3, p2}, Landroid/widget/CursorAdapter;->swapCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    invoke-static {v3, v9}, Lcom/android/email/activity/MailboxListFragment;->access$702(Lcom/android/email/activity/MailboxListFragment;Landroid/os/Parcelable;)Landroid/os/Parcelable;
    ...
    invoke-virtual {v3, v9}, Landroid/widget/CursorAdapter;->swapCursor(Landroid/database/Cursor;)Landroid/database/Cursor;

    .line 830
    iget-object v3, p0, Lcom/android/email/activity/MailboxListFragment$MailboxListLoaderCallbacks;->this$0:Lcom/android/email/activity/MailboxListFragment;

    invoke-virtual {v3, v7}, Landroid/app/ListFragment;->setListShown(Z)V
    ...
    invoke-static {v3, v4}, Lcom/android/email/activity/MailboxListFragment;->access$1302(Lcom/android/email/activity/MailboxListFragment;I)I

    .line 862
    iget-object v3, p0, Lcom/android/email/activity/MailboxListFragment$MailboxListLoaderCallbacks;->this$0:Lcom/android/email/activity/MailboxListFragment;

    #setter for: Lcom/android/email/activity/MailboxListFragment;->mDropTargetView:Lcom/android/email/activity/MailboxListItem;
    invoke-static {v3, v9}, Lcom/android/email/activity/MailboxListFragment;->access$1402(Lcom/android/email/activity/MailboxListFragment;Lcom/android/email/activity/MailboxListItem;)Lcom/android/email/activity/MailboxListItem;

    .line 864
    iput-boolean v7, p0, Lcom/android/email/activity/MailboxListFragment$MailboxListLoaderCallbacks;->mIsFirstLoad:Z
    ...
    :cond_2
    invoke-virtual {v2}, Landroid/widget/AbsListView;->onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 834
    :cond_3
    new-instance v3, Lcom/android/email/activity/MailboxListFragment$LoadVipFolderMessageCountTask;
    ...
    #getter for: Lcom/android/email/activity/MailboxListFragment;->mTaskTracker:Lcom/android/emailcommon/utility/EmailAsyncTask$Tracker;
    invoke-static {v5}, Lcom/android/email/activity/MailboxListFragment;->access$800(Lcom/android/email/activity/MailboxListFragment;)Lcom/android/emailcommon/utility/EmailAsyncTask$Tracker;

    move-result-object v5

    iget-object v6, p0, Lcom/android/email/activity/MailboxListFragment$MailboxListLoaderCallbacks;->this$0:Lcom/android/email/activity/MailboxListFragment;

    #getter for: Lcom/android/email/activity/MailboxListFragment;->mActivity:Landroid/app/Activity;
    invoke-static {v6}, Lcom/android/email/activity/MailboxListFragment;->access$900(Lcom/android/email/activity/MailboxListFragment;)Landroid/app/Activity;

    move-result-object v6

    invoke-direct {v3, v4, v5, v6}, Lcom/android/email/activity/MailboxListFragment$LoadVipFolderMessageCountTask;-><init>(Lcom/android/email/activity/MailboxListFragment;Lcom/android/emailcommon/utility/EmailAsyncTask$Tracker;Landroid/content/Context;)V

    new-array v4, v8, [Ljava/lang/Long;

    iget-object v5, p0, Lcom/android/email/activity/MailboxListFragment$MailboxListLoaderCallbacks;->this$0:Lcom/android/email/activity/MailboxListFragment;

    invoke-virtual {v5}, Lcom/android/email/activity/MailboxListFragment;->getAccountId()J
    ...
    invoke-virtual {v3, v4}, Lcom/android/emailcommon/utility/EmailAsyncTask;->executeParallel([Ljava/lang/Object;)Lcom/android/emailcommon/utility/EmailAsyncTask;

    .line 836
    iget-object v3, p0, Lcom/android/email/activity/MailboxListFragment$MailboxListLoaderCallbacks;->this$0:Lcom/android/email/activity/MailboxListFragment;

    #setter for: Lcom/android/email/activity/MailboxListFragment;->mParentDetermined:Z
    invoke-static {v3, v8}, Lcom/android/email/activity/MailboxListFragment;->access$1002(Lcom/android/email/activity/MailboxListFragment;Z)Z
    ...
    invoke-virtual {v3, v8}, Landroid/app/ListFragment;->setListShown(Z)V

    .line 843
    invoke-virtual {v2, v1}, Landroid/widget/AbsListView;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-static {v3, v10, v11}, Lcom/android/email/activity/MailboxListFragment;->access$1102(Lcom/android/email/activity/MailboxListFragment;J)J
    ...
    invoke-static {v3, v4}, Lcom/android/email/activity/MailboxListFragment;->access$1200(Lcom/android/email/activity/MailboxListFragment;Z)Z
