...
.field public static final HIGHLIGHT_COLOR_INT:I = -0xff0001

.field static final HIGHLIGHT_COLOR_STRING:Ljava/lang/String; = "#00FFFF"
...
.method public static highlightTerms(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/CharSequence;
    ...
    .line 581
    .local v31, terms:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;>;"
    if-eqz p1, :cond_1
    ...
    :goto_1
    invoke-virtual/range {v25 .. v25}, Ljava/util/StringTokenizer;->hasMoreTokens()Z
    ...
    .line 584
    new-instance v32, Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;-><init>(Ljava/lang/String;Z)V
    ...
    .line 592
    .local v23, sb:Ljava/lang/Appendable;
    :goto_2
    const/4 v14, 0x0
    ...
    .line 611
    .local v30, tagLowerCase:Ljava/lang/String;
    const/16 v26, 0x0

    .line 612
    .local v26, stripContent:Z
    ...
    aget-object v27, v5, v12

    .line 613
    .local v27, stripTag:Ljava/lang/String;
    ...
    .line 619
    .end local v27           #stripTag:Ljava/lang/String;
    :cond_3
    if-eqz v26, :cond_8
    ...
    invoke-static {v0, v1, v11}, Lcom/android/emailcommon/utility/TextUtilities;->findTagEnd(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    .end local v12           #i$:I
    .end local v17           #len$:I
    .end local v22           #peek:C
    .end local v26           #stripContent:Z
    .end local v29           #tag:Ljava/lang/String;
    .end local v30           #tagLowerCase:Ljava/lang/String;
    :cond_4
    ...
    .line 590
    .end local v11           #i:I
    .end local v14           #inTag:Z
    .end local v15           #lastOut:I
    .end local v23           #sb:Ljava/lang/Appendable;
    :cond_5
    new-instance v23, Landroid/text/SpannableStringBuilder;

    invoke-direct/range {v23 .. v23}, Landroid/text/SpannableStringBuilder;-><init>()V
    ...
    .restart local v14       #inTag:Z
    .restart local v15       #lastOut:I
    .restart local v17       #len$:I
    .restart local v22       #peek:C
    .restart local v23       #sb:Ljava/lang/Appendable;
    .restart local v26       #stripContent:Z
    .restart local v27       #stripTag:Ljava/lang/String;
    .restart local v29       #tag:Ljava/lang/String;
    .restart local v30       #tagLowerCase:Ljava/lang/String;
    :cond_6
    ...
    invoke-static {v0, v11, v1}, Lcom/android/emailcommon/utility/TextUtilities;->stripHtmlEntity(Ljava/lang/String;I[I)C

    move-result v9

    .line 646
    .local v9, entityChar:C
    const/16 v32, 0x26
    ...
    check-cast v28, Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;

    .line 660
    .local v28, t:Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;
    ...
    iput v11, v0, Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;->mMatchStart:I
    ...
    .line 668
    .local v20, matchText:Ljava/lang/String;
    move-object/from16 v0, v28
    ...
    .line 688
    .end local v20           #matchText:Ljava/lang/String;
    :cond_f
    const/4 v4, 0x0
    ...
    .line 673
    .restart local v20       #matchText:Ljava/lang/String;
    :cond_10
    if-eqz p2, :cond_11

    .line 674
    const-string v32, "<span style=\"background-color: #00FFFF\">"
    ...
    .line 680
    .local v10, highlightSpan:Landroid/text/SpannableString;
    new-instance v32, Landroid/text/style/BackgroundColorSpan;

    const v33, -0xff0001

    invoke-direct/range {v32 .. v33}, Landroid/text/style/BackgroundColorSpan;-><init>(I)V
    ...
    .line 690
    .end local v10           #highlightSpan:Landroid/text/SpannableString;
    .end local v20           #matchText:Ljava/lang/String;
    :cond_12
    move-object/from16 v0, v28
    ...
    check-cast v21, Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;

    .line 695
    .local v21, ot:Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;
    ...
    .line 700
    .end local v21           #ot:Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;
    :cond_15
    move-object/from16 v0, v28
    ...
    .end local v16           #leastOtherStart:I
    .end local v19           #matchEnd:I
    :cond_17
    :goto_a
    const/16 v32, 0x0
    ...
    .restart local v16       #leastOtherStart:I
    .restart local v19       #matchEnd:I
    :cond_18
    move-object/from16 v0, v28
    ...
    .end local v16           #leastOtherStart:I
    .end local v19           #matchEnd:I
    .end local v28           #t:Lcom/android/emailcommon/utility/TextUtilities$SearchTerm;
    :cond_1a
    if-eqz v4, :cond_9
