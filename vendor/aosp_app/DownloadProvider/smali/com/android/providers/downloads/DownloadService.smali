...
# instance fields
.field private mDownloads:Ljava/util/SortedMap;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/providers/downloads/DownloadService;->mDownloads:Ljava/util/SortedMap;
...
.method static synthetic access$400(Lcom/android/providers/downloads/DownloadService;)Ljava/util/SortedMap;
    .locals 1
    .parameter "x0"

    .prologue
    .line 64
    iget-object v0, p0, Lcom/android/providers/downloads/DownloadService;->mDownloads:Ljava/util/SortedMap;
...
.method static synthetic access$600(Lcom/android/providers/downloads/DownloadService;Lcom/android/providers/downloads/DownloadInfo$Reader;J)Lcom/android/providers/downloads/DownloadInfo;
    ...
    .prologue
    .line 64
    invoke-direct {p0, p1, p2, p3}, Lcom/android/providers/downloads/DownloadService;->insertDownloadLocked(Lcom/android/providers/downloads/DownloadInfo$Reader;J)Lcom/android/providers/downloads/DownloadInfo;
...
.method static synthetic access$800(Lcom/android/providers/downloads/DownloadService;J)V
    ...
    .prologue
    .line 64
    invoke-direct {p0, p1, p2}, Lcom/android/providers/downloads/DownloadService;->deleteDownloadLocked(J)V

    return-void
.end method

.method static synthetic access$900(Lcom/android/providers/downloads/DownloadService;)Lcom/android/providers/downloads/DownloadNotifier;
    .locals 1
    .parameter "x0"
...
.method private deleteDownloadLocked(J)V
    ...
    .prologue
    .line 481
    iget-object v7, p0, Lcom/android/providers/downloads/DownloadService;->mDownloads:Ljava/util/SortedMap;
    ...
    invoke-virtual {v3}, Lcom/android/providers/downloads/DownloadInfo;->shouldScanFile()Z
    ...
    invoke-direct {p0, v3, v7, v8}, Lcom/android/providers/downloads/DownloadService;->scanFile(Lcom/android/providers/downloads/DownloadInfo;ZZ)Z

    .line 485
    :cond_0
    iget v7, v3, Lcom/android/providers/downloads/DownloadInfo;->mStatus:I
    ...
    iput v7, v3, Lcom/android/providers/downloads/DownloadInfo;->mStatus:I

    .line 488
    :cond_1
    iget v7, v3, Lcom/android/providers/downloads/DownloadInfo;->mDestination:I

    if-eqz v7, :cond_2

    iget-object v7, v3, Lcom/android/providers/downloads/DownloadInfo;->mFileName:Ljava/lang/String;
    ...
    const-string v9, "deleteDownloadLocked() deleting "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, v3, Lcom/android/providers/downloads/DownloadInfo;->mFileName:Ljava/lang/String;
    ...
    iget-object v8, v3, Lcom/android/providers/downloads/DownloadInfo;->mFileName:Ljava/lang/String;
    ...
    .line 494
    :cond_2
    iget-object v7, p0, Lcom/android/providers/downloads/DownloadService;->mNotifier:Lcom/android/providers/downloads/DownloadNotifier;

    invoke-virtual {v7}, Lcom/android/providers/downloads/DownloadNotifier;->getPendingIntentsMap()Ljava/util/HashMap;

    move-result-object v7

    iget-wide v8, v3, Lcom/android/providers/downloads/DownloadInfo;->mId:J
    ...
    invoke-virtual {v7}, Lcom/android/providers/downloads/DownloadNotifier;->getNotificationContext()Landroid/content/Context;
    ...
    const-string v7, "android.intent.action.DOWNLOAD_HIDE"
    ...
    const-string v9, "DownloadService: deleteDownload before notifyUrl: info.mStatus is :"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, v3, Lcom/android/providers/downloads/DownloadInfo;->mStatus:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, "info.mFileName is: "
    ...
    const-string v9, " info.mOmaDownload is:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, v3, Lcom/android/providers/downloads/DownloadInfo;->mOmaDownload:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, " info.mOmaDownloadInsNotifyUrl is:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, v3, Lcom/android/providers/downloads/DownloadInfo;->mOmaDownloadInsNotifyUrl:Ljava/lang/String;

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, " info.mOmaDownloadStatus is: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, v3, Lcom/android/providers/downloads/DownloadInfo;->mOmaDownloadStatus:I
    ...
    :cond_6
    iget v7, v3, Lcom/android/providers/downloads/DownloadInfo;->mOmaDownload:I

    const/4 v8, 0x1

    if-ne v7, v8, :cond_7

    iget-object v7, v3, Lcom/android/providers/downloads/DownloadInfo;->mOmaDownloadInsNotifyUrl:Ljava/lang/String;

    if-eqz v7, :cond_7

    iget v7, v3, Lcom/android/providers/downloads/DownloadInfo;->mOmaDownloadStatus:I
    ...
    .line 540
    :cond_8
    iget v6, v3, Lcom/android/providers/downloads/DownloadInfo;->mOmaDownloadStatus:I

    .line 542
    .local v6, omaDownloadStatus:I
    :try_start_0
    ...
    .line 543
    .local v5, notifyUrl:Ljava/net/URL;
    new-instance v4, Lcom/android/providers/downloads/DownloadService$1;

    invoke-direct {v4, p0, v5, v6}, Lcom/android/providers/downloads/DownloadService$1;-><init>(Lcom/android/providers/downloads/DownloadService;Ljava/net/URL;I)V

    .line 561
    .local v4, nofiyUrlThread:Ljava/lang/Thread;
    invoke-virtual {v4}, Ljava/lang/Thread;->start()V
    :try_end_0
    .catch Ljava/net/MalformedURLException; {:try_start_0 .. :try_end_0} :catch_0

    .line 568
    .end local v4           #nofiyUrlThread:Ljava/lang/Thread;
    .end local v5           #notifyUrl:Ljava/net/URL;
    .end local v6           #omaDownloadStatus:I
    :cond_9
    :goto_0
    return-void

    .line 562
    .restart local v6       #omaDownloadStatus:I
    :catch_0
    move-exception v2
...
.method private deleteFileIfExists(Ljava/lang/String;)V
    ...
    const-string v4, "deleteFileIfExists() deleting "
...
.method private insertDownloadLocked(Lcom/android/providers/downloads/DownloadInfo$Reader;J)Lcom/android/providers/downloads/DownloadInfo;
    ...
    iget-object v1, p0, Lcom/android/providers/downloads/DownloadService;->mDownloads:Ljava/util/SortedMap;
...
.method private scanFile(Lcom/android/providers/downloads/DownloadInfo;ZZ)Z
    ...
    new-instance v0, Lcom/android/providers/downloads/DownloadService$2;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/providers/downloads/DownloadService$2;-><init>(Lcom/android/providers/downloads/DownloadService;ZLandroid/net/Uri;ZJ)V
...
.method private updateDownload(Lcom/android/providers/downloads/DownloadInfo$Reader;Lcom/android/providers/downloads/DownloadInfo;J)V
    ...
    .prologue
    .line 466
    iget v1, p2, Lcom/android/providers/downloads/DownloadInfo;->mVisibility:I
    ...
    const-string v4, "processing updated download "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-wide v4, p2, Lcom/android/providers/downloads/DownloadInfo;->mId:J
    ...
    invoke-virtual {p2, p3, p4, v2}, Lcom/android/providers/downloads/DownloadInfo;->startIfReady(JLcom/android/providers/downloads/StorageManager;)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/providers/downloads/DownloadService;->mDownloads:Ljava/util/SortedMap;

    monitor-enter v6

    .line 652
    :try_start_0
    iget-object v5, p0, Lcom/android/providers/downloads/DownloadService;->mDownloads:Ljava/util/SortedMap;
    ...
    invoke-interface {v5, v1}, Ljava/util/SortedMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
