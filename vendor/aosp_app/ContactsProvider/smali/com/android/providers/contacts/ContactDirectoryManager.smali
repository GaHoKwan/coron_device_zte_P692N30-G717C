...
.method private updateDirectoriesForPackage(Landroid/content/pm/PackageInfo;Z)Ljava/util/List;
    ...
    .line 370
    .local v9, provider:Landroid/content/pm/ProviderInfo;
    invoke-static {v9}, Lcom/android/providers/contacts/ContactDirectoryManager;->isDirectoryProvider(Landroid/content/pm/ProviderInfo;)Z
    ...
    invoke-virtual {v0, v3, v9}, Lcom/android/providers/contacts/ContactDirectoryManager;->queryDirectoriesForAuthority(Ljava/util/ArrayList;Landroid/content/pm/ProviderInfo;)V
    ...
    .end local v5           #i$:I
    .end local v7           #len$:I
    .end local v9           #provider:Landroid/content/pm/ProviderInfo;
    :cond_1
    ...
    iget-wide v12, v6, Lcom/android/providers/contacts/ContactDirectoryManager$DirectoryInfo;->id:J
    ...
    .line 408
    .local v4, ex:Landroid/database/sqlite/SQLiteCantOpenDatabaseException;
    const-string v12, "ContactDirectoryManager"

    const-string v13, "[updateDirectoriesForPackage]catch SQLiteCantOpenDatabaseException for endTransaction()"
    ...
    .line 407
    .end local v4           #ex:Landroid/database/sqlite/SQLiteCantOpenDatabaseException;
    ...
    .line 408
    .restart local v4       #ex:Landroid/database/sqlite/SQLiteCantOpenDatabaseException;
    const-string v13, "ContactDirectoryManager"

    const-string v14, "[updateDirectoriesForPackage]catch SQLiteCantOpenDatabaseException for endTransaction()"
...
.method public getDbHelper()Lcom/android/providers/contacts/ContactsDatabaseHelper;
    ...
    invoke-virtual {v0}, Lcom/android/providers/contacts/AbstractContactsProvider;->getDatabaseHelper()Landroid/database/sqlite/SQLiteOpenHelper;
