...
.field public static final DATA_JOIN_MIMETYPE_RAW_CONTACTS:Ljava/lang/String; = "data JOIN mimetypes ON (data.mimetype_id = mimetypes._id) JOIN raw_contacts ON (data.raw_contact_id = raw_contacts._id) JOIN accounts ON (raw_contacts.account_id=accounts._id)"
...
.field public static final DIALER_SEARCH:Ljava/lang/String; = "dialer_search"
