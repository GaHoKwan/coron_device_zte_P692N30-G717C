...
.method static encodeToJSON(Landroid/os/Debug$MemoryInfo;)Ljava/lang/String;
    .locals 12
    ...
    .line 136
    .local v1, memoryUsage:Ljava/lang/StringBuilder;
    const-string v2, "{\r\n"
    ...
    const-string v3, "    \"Browser app (MB)\": {\r\n"
    ...
    const-string v3, "                \"Native\": %.2f,\r\n"

    new-array v4, v10, [Ljava/lang/Object;

    iget v5, p0, Landroid/os/Debug$MemoryInfo;->nativePss:I
    ...
    iget v5, p0, Landroid/os/Debug$MemoryInfo;->dalvikPrivateDirty:I
    ...
    iget v5, p0, Landroid/os/Debug$MemoryInfo;->nativePrivateDirty:I
    ...
    iget v5, p0, Landroid/os/Debug$MemoryInfo;->otherPrivateDirty:I
    ...
    iget v5, p0, Landroid/os/Debug$MemoryInfo;->dalvikSharedDirty:I
    ...
    iget v5, p0, Landroid/os/Debug$MemoryInfo;->nativeSharedDirty:I
    ...
    iget v5, p0, Landroid/os/Debug$MemoryInfo;->otherSharedDirty:I
    ...
    invoke-virtual {p0, v0}, Landroid/os/Debug$MemoryInfo;->getOtherPss(I)I
    ...
    invoke-virtual {p0, v0}, Landroid/os/Debug$MemoryInfo;->getOtherSharedDirty(I)I
...
.method static printMemoryInfo(Z)Ljava/lang/String;
    ...
    const-string v9, "/storage/sdcard0/memDumpLog"
    ...
    invoke-static {v3}, Lcom/android/browser/Performance;->encodeToJSON(Landroid/os/Debug$MemoryInfo;)Ljava/lang/String;
