...
.method public constructor <init>(Ljava/nio/ByteBuffer;)V
    ...
    .line 258
    const-string v14, "mp4parser-AvcConfigurationBoxc"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v16, "buffer remaining:"
    ...
    .restart local v10       #sequenceParameterSetExtLength:I
    .restart local v11       #sequenceParameterSetExtNALUnit:[B
    :cond_5
    move-object/from16 v0, p1
...
.method public getPPS()[Ljava/lang/String;
    ...
    .line 343
    .local v4, pictureParameterSet:[B
    const-string v0, "not parsable"

    .line 345
    .local v0, details:Ljava/lang/String;
    :try_start_0
    invoke-static {v4}, Lcom/googlecode/mp4parser/h264/model/PictureParameterSet;->read([B)Lcom/googlecode/mp4parser/h264/model/PictureParameterSet;
    ...
    .end local v4           #pictureParameterSet:[B
    :cond_0
...
.method public getSPS()[Ljava/lang/String;
    ...
    .line 358
    .local v3, sequenceParameterSet:[B
    const-string v0, "not parsable"
    ...
    .end local v3           #sequenceParameterSet:[B
    :cond_0
    ...
    .restart local v3       #sequenceParameterSet:[B
    :catch_0
    move-exception v4
