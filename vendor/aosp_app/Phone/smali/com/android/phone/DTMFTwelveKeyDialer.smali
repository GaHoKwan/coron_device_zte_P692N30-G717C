...
.method private constructor <init>(Lcom/android/phone/InCallScreen;)V
    ...
    .line 1155
    iput-object v1, p0, Lcom/android/phone/DTMFTwelveKeyDialer;->mAudioManager:Landroid/media/AudioManager;
...
.method public constructor <init>(Lcom/android/phone/InCallScreen;Landroid/view/ViewStub;)V
    ...
    iput-object v0, p0, Lcom/android/phone/DTMFTwelveKeyDialer;->mAudioManager:Landroid/media/AudioManager;
...
.method private final processDtmf(CZ)V
    ...
    .line 894
    invoke-direct {p0, p1}, Lcom/android/phone/DTMFTwelveKeyDialer;->processDtmfForVtIfNeeded(C)V
...
.method private sendBurstDtmf(Ljava/lang/String;)V
    .locals 6
    .parameter "dtmfStr"
    ...
    invoke-interface {v0, p1, v4, v4, v2}, Lcom/android/internal/telephony/Phone;->sendBurstDtmf(Ljava/lang/String;IILandroid/os/Message;)V
    ...
    invoke-virtual {v2, p1, v4, v4, v3}, Lcom/android/internal/telephony/CallManager;->sendBurstDtmf(Ljava/lang/String;IILandroid/os/Message;)Z
...
.method private sendShortDtmfToNetwork(C)V
    ...
    invoke-direct {p0, v0}, Lcom/android/phone/DTMFTwelveKeyDialer;->sendBurstDtmf(Ljava/lang/String;)V
...
.method private startLocalToneIfNeededForDualTalk(C)V
    .locals 4
    .parameter "c"
    ...
    .line 1194
    invoke-static {p1, v2}, Lcom/mediatek/phone/DualTalkUtils;->generateBurstDtmfparam(CZ)Ljava/lang/String;
    ...
    const-string v3, "startLocalToneIfNeeded: "
    ...
    .line 1200
    :goto_0
    iget-object v1, p0, Lcom/android/phone/DTMFTwelveKeyDialer;->mAudioManager:Landroid/media/AudioManager;

    invoke-virtual {v1, v0}, Landroid/media/AudioManager;->setParameters(Ljava/lang/String;)V

    .line 1201
    iput-char p1, p0, Lcom/android/phone/DTMFTwelveKeyDialer;->mDtmfChar:C
    ...
    :cond_1
    invoke-static {p1, v2}, Lcom/mediatek/phone/DualTalkUtils;->generateDtmfparam(CZ)Ljava/lang/String;
...
.method public startLocalToneIfNeeded(C)V
    ...
    .line 1049
    :cond_3
    invoke-direct {p0, p1}, Lcom/android/phone/DTMFTwelveKeyDialer;->startLocalToneIfNeededForDualTalk(C)V
...
.method public stopLocalToneIfNeeded()V
    ...
    .line 1109
    iget-object v0, p0, Lcom/android/phone/DTMFTwelveKeyDialer;->mAudioManager:Landroid/media/AudioManager;

    iget-char v2, p0, Lcom/android/phone/DTMFTwelveKeyDialer;->mDtmfChar:C

    const/4 v3, 0x0

    invoke-static {v2, v3}, Lcom/mediatek/phone/DualTalkUtils;->generateDtmfparam(CZ)Ljava/lang/String;
