...
.method public isPhoneCallAllowed(I)Z
    ...
    invoke-virtual {v4}, Lcom/android/phone/PhoneGlobals;->isBTConnected()Z
...
.method public isRingingWhenOutgoing()Z
    ...
    .line 575
    sget-boolean v8, Lcom/mediatek/phone/DualTalkUtils;->sIsSupportDualTalk:Z

    if-eqz v8, :cond_0

    iget-object v8, p0, Lcom/mediatek/phone/DualTalkUtils;->mActivePhoneList:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/cdma/CdmaConnection;->isIncoming()Z

    move-result v8

    if-nez v8, :cond_5

    invoke-virtual {v1}, Lcom/android/internal/telephony/cdma/CdmaConnection;->isRealConnected()Z
    ...
    .end local v2           #connections:Ljava/util/List;
    :cond_3
    :goto_1
    if-eqz v5, :cond_4
    ...
    .restart local v2       #connections:Ljava/util/List;
    :cond_5
    move v5, v7
...
.method public updateState()V
    ...
    .line 280
    invoke-interface {v6, v9, v10}, Lcom/android/internal/telephony/Phone;->requestSwitchHPF(ZLandroid/os/Message;)V
    ...
    invoke-virtual {v7, v9, v4}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V
    ...
    .line 318
    invoke-interface {v6, v11, v10}, Lcom/android/internal/telephony/Phone;->requestSwitchHPF(ZLandroid/os/Message;)V
