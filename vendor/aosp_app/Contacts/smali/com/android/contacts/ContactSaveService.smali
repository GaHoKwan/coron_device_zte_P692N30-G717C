...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/contacts/ContactSaveService$DeleteEndListener;,
...
.field public static final ACTION_SAVE_GROUP_TO_CONTACT:Ljava/lang/String; = "saveGroupToContact"

.field public static final ACTION_SET_BLOCK_VIDEO_CALL:Ljava/lang/String; = "blockVideoCall"
...
.field private static final ALLOWED_DATA_COLUMNS:Ljava/util/HashSet; = null
...
.field public static final CREATE_GROUP_COMP:Ljava/lang/String; = "create_group_successful"
...
.field public static final EXTRA_BLOCK_VIDEO_CALL_FLAG:Ljava/lang/String; = "blockVideoCallFlag"
...
.field public static final EXTRA_GROUP_ID_LIST:Ljava/lang/String; = "groupIdList"

.field public static final EXTRA_GROUP_LABEL:Ljava/lang/String; = "groupLabel"

.field public static final EXTRA_GROUP_MEMBERSHIP_NAME:Ljava/lang/String; = "groupMembershipName"

.field public static final EXTRA_GROUP_NAME_LIST:Ljava/lang/String; = "groupNameList"

.field public static final EXTRA_NEW_GROUP_NAME:Ljava/lang/String; = "addGroupName"

.field public static final EXTRA_ORIGINAL_GROUP_NAME:Ljava/lang/String; = "originalGroupName"

.field public static final EXTRA_RAW_CONTACTS_ID:Ljava/lang/String; = "rawContactsId"
...
.field public static final EXTRA_RAW_CONTACT_IDS:Ljava/lang/String; = "rawContactIds"
...
.field public static final EXTRA_SIM_INDEX:Ljava/lang/String; = "simIndex"

.field public static final EXTRA_SIM_INDEX_ARRAY:Ljava/lang/String; = "simIndexArray"

.field public static final EXTRA_SIM_INDEX_TO_ADD:Ljava/lang/String; = "simIndexToAdd"

.field public static final EXTRA_SIM_INDEX_TO_REMOVE:Ljava/lang/String; = "simIndexToRemove"

.field public static final EXTRA_SIM_OR_PHONE:Ljava/lang/String; = "simOrPhone"

.field public static final EXTRA_SLOT_ID:Ljava/lang/String; = "slotId"
...
.field private static final GROUP_SIM_ABSENT:I = 0x4

.field private static final PERSIST_TRIES:I = 0x3

.field public static final RAW_CONTACTS_TABLE:Ljava/lang/String; = "raw_contacts"

.field private static final TAG:Ljava/lang/String; = "ContactSaveService"

.field private static mIsTransactionProcessing:Z

.field private static sDeleteEndListener:Lcom/android/contacts/ContactSaveService$DeleteEndListener;
...
.field private mSlotError:Landroid/util/SparseIntArray;
...
.method static constructor <clinit>()V
    ...
    .line 2158
    sput-boolean v3, Lcom/android/contacts/ContactSaveService;->mIsTransactionProcessing:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/contacts/ContactSaveService;->mSlotError:Landroid/util/SparseIntArray;
...
.method private addMembersToGroup(Landroid/content/ContentResolver;[JJ[III)Z
    .locals 20
    .parameter "resolver"
    .parameter "rawContactsToAdd"
    .parameter "groupId"
    .parameter "simIndexArry"
    .parameter "slotId"
    .parameter "ugrpId"
    ...
    .line 1860
    const-string v16, "ContactSaveService"

    const-string v17, "addMembersToGroup(),the is null."

    invoke-static/range {v16 .. v17}, Lcom/mediatek/contacts/util/LogUtils;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1867
    .local v2, MAX_OP_COUNT_IN_ONE_BATCH:I
    new-instance v12, Ljava/util/ArrayList;

    invoke-direct {v12}, Ljava/util/ArrayList;-><init>()V

    .line 1868
    .local v12, rawContactOperations:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ContentProviderOperation;>;"
    const/4 v6, 0x0
    ...
    const-string v18, "[addMembersToGroup] slotId:"
    ...
    invoke-static/range {v16 .. v17}, Lcom/mediatek/contacts/util/LogUtils;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v18, "[addMembersToGroup] simIndex:"
    ...
    const-string v18, "[addMembersToGroup] ugrpId:"
    ...
    invoke-static {v0, v15, v1}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->addUSIMGroupMember(III)Z
    ...
    const-string v18, "[addMembersToGroup] ret "
    ...
    const-string v17, "addMembersToGroup(),insert into iccProvider failed."
    ...
    invoke-static/range {v16 .. v16}, Landroid/content/ContentProviderOperation;->newAssertQuery(Landroid/net/Uri;)Landroid/content/ContentProviderOperation$Builder;

    move-result-object v3

    .line 1889
    .local v3, assertBuilder:Landroid/content/ContentProviderOperation$Builder;
    const-string v16, "raw_contact_id=? AND mimetype=? AND data1=?"
    ...
    invoke-virtual {v3, v0}, Landroid/content/ContentProviderOperation$Builder;->withExpectedCount(I)Landroid/content/ContentProviderOperation$Builder;
    ...
    const-string v17, "mCount >MAX_OP_COUNT_IN_ONE_BATCH"
    ...
    const-string v18, "Problem persisting user edits for raw contact ID "
    ...
    const-string v18, "Assert failed in adding raw contact ID "
    ...
    const-string v18, ". Already exists in group "
    ...
    .line 1936
    .end local v3           #assertBuilder:Landroid/content/ContentProviderOperation$Builder;
    ...
    const-string v17, "Problem persisting user edits for raw contact ID "
    ...
    const-string v17, "Assert failed in adding raw contact ID . Already exists in group "
...
.method private checkAllSlotErrors()V
    .locals 6
    ...
    .local v1, i:I
    :goto_0
    iget-object v3, p0, Lcom/android/contacts/ContactSaveService;->mSlotError:Landroid/util/SparseIntArray;
    ...
    const-string v5, "[showToast] slot "
    ...
    const-string v5, " encounter a problem: "
    ...
    .line 2133
    invoke-direct {p0, v0, v2}, Lcom/android/contacts/ContactSaveService;->showMoveUSIMGroupErrorToast(II)V
...
.method private checkGroupNameExist(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    .locals 10
    .parameter "groupName"
...
.method public static createContactDetailGroupUpdateIntent(Landroid/content/Context;J[JIILjava/lang/Class;Ljava/lang/String;)Landroid/content/Intent;
    .locals 3
    .parameter "context"
    .parameter "currentRawContactId"
    ...
    const-string v2, "saveGroupToContact"

    invoke-virtual {v1, v2}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    .line 1832
    const-string v2, "rawContactsId"

    invoke-virtual {v1, v2, p1, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;J)Landroid/content/Intent;

    .line 1833
    const-string v2, "rawContactIds"
...
.method public static createContactDetailGroupUpdateIntent(Landroid/content/Context;J[JILjava/lang/Class;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;I)Landroid/content/Intent;
    .locals 11
    .parameter "context"
    .parameter "currentRawContactId"
    .parameter "rawContactIds"
    ...
    .local p7, mSelectedGroupsIdList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    .local p8, mSelectedGroupsNameList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    .local p9, mGroupMemberShipName:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    move-object v1, p0
    ...
    invoke-static/range {v1 .. v8}, Lcom/android/contacts/ContactSaveService;->createContactDetailGroupUpdateIntent(Landroid/content/Context;J[JIILjava/lang/Class;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v10

    .line 1805
    .local v10, saveIntent:Landroid/content/Intent;
    const-string v1, "groupIdList"

    move-object/from16 v0, p7

    invoke-virtual {v10, v1, v0}, Landroid/content/Intent;->putIntegerArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;

    .line 1806
    const-string v1, "groupNameList"

    move-object/from16 v0, p8

    invoke-virtual {v10, v1, v0}, Landroid/content/Intent;->putStringArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;

    .line 1807
    const-string v1, "groupMembershipName"
    ...
    .line 1812
    .local v9, callbackIntent:Landroid/content/Intent;
    return-object v10
.end method
...
.method private createGroup(Landroid/content/Intent;)V
    ...
    .line 702
    .local v4, rawContactsToAdd:[J
    const-string v2, "simIndexArray"
    ...
    const-string v6, "[createGroup]groupName:"
    ...
    invoke-static {v2, v5}, Lcom/mediatek/contacts/util/LogUtils;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v10, v11, v2}, Lcom/android/contacts/ContactSaveService;->checkGroupNameExist(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v5, "[createGroup] Group Name exist!"
    ...
    invoke-virtual {v12, v2, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;
    ...
    .line 715
    .end local v12           #callbackIntent:Landroid/content/Intent;
    :cond_0
    const/4 v9, -0x1
    ...
    invoke-static {v8, v0}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->syncUSIMGroupNewIfMissing(ILjava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 757
    .local v15, groupUri:Landroid/net/Uri;
    if-nez v15, :cond_2
    ...
    const-string v6, "Couldn\'t create group with label "
    ...
    invoke-static {v2, v5}, Lcom/mediatek/contacts/util/LogUtils;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 762
    .restart local v12       #callbackIntent:Landroid/content/Intent;
    if-eqz v15, :cond_6
    ...
    invoke-direct/range {v2 .. v9}, Lcom/android/contacts/ContactSaveService;->addMembersToGroup(Landroid/content/ContentResolver;[JJ[III)Z
    ...
    const-string v6, "createGroup(),isSuccess:"
    ...
    .line 767
    invoke-static {v8}, Lcom/mediatek/contacts/simcontact/SimCardUtils;->isSimInserted(I)Z
    ...
    const-string v5, "[createGroup] Find sim removed"
    ...
    invoke-direct {v0, v2, v8}, Lcom/android/contacts/ContactSaveService;->showMoveUSIMGroupErrorToast(II)V
    ...
    .end local v12           #callbackIntent:Landroid/content/Intent;
    .end local v15           #groupUri:Landroid/net/Uri;
    ...
    .line 722
    .local v14, e:Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroupException;
    const-string v2, "ContactSaveService"
    ...
    const-string v6, "[SyncUSIMGroup] catched USIMGroupException. ErrorType: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    invoke-virtual {v14}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroupException;->getErrorType()I
    ...
    const-string v6, "[SyncUSIMGroup] catched USIMGroupException. getErrorSlotId: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    invoke-virtual {v14}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroupException;->getErrorSlotId()I
    ...
    iget-object v2, v0, Lcom/android/contacts/ContactSaveService;->mSlotError:Landroid/util/SparseIntArray;
    ...
    .line 728
    invoke-direct/range {p0 .. p0}, Lcom/android/contacts/ContactSaveService;->checkAllSlotErrors()V
    ...
    const-string v5, "GROUP_NAME_OUT_OF_BOUND, need to reload contact data."
    ...
    const-string v5, "Some other USIM Exceptions happened here."
    ...
    .line 777
    .end local v14           #e:Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroupException;
    .restart local v3       #resolver:Landroid/content/ContentResolver;
    .restart local v15       #groupUri:Landroid/net/Uri;
    ...
    invoke-virtual {v12, v2, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;
    ...
    .line 796
    const-string v2, "create_group_successful"
    ...
    const-string v5, "createGroup(),setData == nul"

    invoke-static {v2, v5}, Lcom/mediatek/contacts/util/LogUtils;->w(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static createGroupDeletionIntent(Landroid/content/Context;JIILjava/lang/String;)Landroid/content/Intent;
    .locals 2
    .parameter "context"
    .parameter "groupId"
    .parameter "simId"
    ...
    .prologue
    .line 2041
    invoke-static {p0, p1, p2}, Lcom/android/contacts/ContactSaveService;->createGroupDeletionIntent(Landroid/content/Context;J)Landroid/content/Intent;
...
.method public static createGroupUpdateIntent(Landroid/content/Context;JLjava/lang/String;[J[JLjava/lang/Class;Ljava/lang/String;Ljava/lang/String;I[I[ILcom/android/contacts/model/account/AccountWithDataSet;)Landroid/content/Intent;
    .locals 5
    .parameter "context"
    .parameter "groupId"
    .parameter "newLabel"
    ...
    .parameter "slotId"
    .parameter "simIndexToAddArray"
    .parameter "simIndexToRemoveArray"
    .parameter "account"
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1761
    .local p6, callbackActivity:Ljava/lang/Class;,"Ljava/lang/Class<+Landroid/app/Activity;>;"
    invoke-static/range {p0 .. p7}, Lcom/android/contacts/ContactSaveService;->createGroupUpdateIntent(Landroid/content/Context;JLjava/lang/String;[J[JLjava/lang/Class;Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 1765
    const-string v3, "simIndexToAdd"

    invoke-virtual {v2, v3, p10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[I)Landroid/content/Intent;

    .line 1766
    const-string v3, "simIndexToRemove"
    ...
    .line 1767
    const-string v3, "originalGroupName"
    ...
    iget-object v4, v0, Lcom/android/contacts/model/account/AccountWithDataSet;->dataSet:Ljava/lang/String;
...
.method public static createNewGroupIntent(Landroid/content/Context;Lcom/android/contacts/model/account/AccountWithDataSet;Ljava/lang/String;[JLjava/lang/Class;Ljava/lang/String;)Landroid/content/Intent;
    ...
    iget-object v3, p1, Lcom/android/contacts/model/account/AccountWithDataSet;->dataSet:Ljava/lang/String;
...
.method public static createNewGroupIntent(Landroid/content/Context;Lcom/android/contacts/model/account/AccountWithDataSet;Ljava/lang/String;[JLjava/lang/Class;Ljava/lang/String;[II)Landroid/content/Intent;
    .locals 3
    .parameter "context"
    .parameter "account"
    .parameter "label"
    ...
    .line 1709
    .local p4, callbackActivity:Ljava/lang/Class;,"Ljava/lang/Class<+Landroid/app/Activity;>;"
    invoke-static/range {p0 .. p5}, Lcom/android/contacts/ContactSaveService;->createNewGroupIntent(Landroid/content/Context;Lcom/android/contacts/model/account/AccountWithDataSet;Ljava/lang/String;[JLjava/lang/Class;Ljava/lang/String;)Landroid/content/Intent;
...
.method public static createNewGroupIntentFromRawContactEditor(Landroid/content/Context;Lcom/android/contacts/model/account/AccountWithDataSet;Ljava/lang/String;[JLjava/lang/Class;Ljava/lang/String;JI)Landroid/content/Intent;
    .locals 3
    .parameter "context"
    .parameter "account"
    .parameter "label"
...
.method public static createNewRawContactIntent(Landroid/content/Context;Ljava/util/ArrayList;Lcom/android/contacts/model/account/AccountWithDataSet;Ljava/lang/Class;Ljava/lang/String;)Landroid/content/Intent;
    ...
    iget-object v3, p2, Lcom/android/contacts/model/account/AccountWithDataSet;->dataSet:Ljava/lang/String;
...
.method public static createSetBlockVideoCall(Landroid/content/Context;Landroid/net/Uri;Z)Landroid/content/Intent;
    .locals 2
    .parameter "context"
    .parameter "contactUri"
    .parameter "value"
    ...
    .line 1357
    .local v0, serviceIntent:Landroid/content/Intent;
    const-string v1, "blockVideoCall"
    ...
    .line 1359
    const-string v1, "blockVideoCallFlag"
...
.method private deleteDataByContactInfo([JJ)V
    .locals 12
    .parameter "rawContactIds"
    .parameter "mRawContactId"
...
.method private deleteGroup(Landroid/content/Intent;)V
    ...
    .prologue
    .line 851
    sget-object v2, Lcom/android/contacts/ContactSaveService;->sDeleteEndListener:Lcom/android/contacts/ContactSaveService$DeleteEndListener;
    ...
    invoke-interface {v2}, Lcom/android/contacts/ContactSaveService$DeleteEndListener;->onDeleteStart()V
    ...
    const-string v4, "Invalid arguments for deleteGroup request"
    ...
    .line 864
    .local v13, groupLabel:Ljava/lang/String;
    const-string v2, "ContactSaveService"
    ...
    const-string v5, "[deleteGroup]groupLabel:"
    ...
    invoke-static {v0, v13}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->hasExistGroup(ILjava/lang/String;)I
    ...
    const-string v5, "[deleteGroup]ugrpId:"
    ...
    .line 882
    .local v16, simId:I
    sget-object v2, Landroid/provider/ContactsContract$Contacts;->CONTENT_GROUP_URI:Landroid/net/Uri;
    ...
    const-string v5, "[deleteGroup]simId:"
    ...
    .line 890
    .local v14, indexInSim:I
    move/from16 v0, v17

    move/from16 v1, v18

    invoke-static {v0, v14, v1}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->deleteUSIMGroupMember(III)Z
    ...
    const-string v5, "[deleteGroup]slotId:"
    ...
    invoke-static {v0, v13}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->deleteUSIMGroup(ILjava/lang/String;)I
    ...
    const-string v5, "[deleteGroup]error:"
    ...
    invoke-interface {v2}, Lcom/android/contacts/ContactSaveService$DeleteEndListener;->onDeleteEnd()V
...
.method private insertDataByNewGroupId(Ljava/util/List;[JJ)Z
    .locals 17
    .parameter
    .parameter "rawContactIds"
    .parameter "mRawContactId"
    ...
    .prologue
    .line 1029
    .local p1, mSelectedGroupsIdList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/Integer;>;"
    const/4 v6, 0x1
    ...
    .line 1034
    .local v4, groupId:Ljava/lang/Integer;
    ...
    const-string v14, "[insertDataByNewGroupId] groupId: "
    ...
    .line 1053
    .end local v2           #builder:Landroid/content/ContentProviderOperation$Builder;
    .end local v4           #groupId:Ljava/lang/Integer;
    :cond_2
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Landroid/content/ContextWrapper;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-virtual {v12, v13, v9}, Landroid/content/ContentResolver;->applyBatch(Ljava/lang/String;Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/content/OperationApplicationException; {:try_start_0 .. :try_end_0} :catch_1
...
.method public static declared-synchronized isGroupTransactionProcessing()Z
    .locals 2
    ...
    :try_start_0
    sget-boolean v1, Lcom/android/contacts/ContactSaveService;->mIsTransactionProcessing:Z
    :try_end_0
...
.method private joinContacts(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v4, v2}, Lcom/android/contacts/ContactSaveService;->bufferOperations(Ljava/util/ArrayList;Landroid/content/ContentResolver;)V
...
.method private operateUSIMGroupContacts(Ljava/util/ArrayList;Ljava/util/ArrayList;II)Z
    .locals 9
    .parameter
    .parameter
    .parameter "simIndex"
    ...
    .prologue
    .line 966
    .local p1, mGroupMemberShipName:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    .local p2, mSelectedGroupsNameList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const/4 v4, 0x0
    ...
    invoke-static {p4, v1}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->hasExistGroup(ILjava/lang/String;)I

    move-result v5

    .line 972
    .local v5, ugrpId:I
    invoke-static {p4, p3, v5}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->deleteUSIMGroupMember(III)Z

    move-result v4

    .line 973
    const-string v6, "GroupMemberChange"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "DELETE ret == "
    ...
    .line 983
    .restart local v5       #ugrpId:I
    invoke-static {p4, p3, v5}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->addUSIMGroupMember(III)Z
...
.method public static registerListener(Lcom/android/contacts/ContactSaveService$Listener;)V
    ...
    const-string v4, "Only activities can be registered to receive callback from "
    ...
    const-string v4, "listener added to SaveService: "
    ...
    .line 197
    instance-of v2, p0, Lcom/android/contacts/activities/ContactEditorActivity;
    ...
    .line 199
    .local v0, currentlistener:Lcom/android/contacts/ContactSaveService$Listener;
    instance-of v2, v0, Lcom/android/contacts/activities/ContactEditorActivity;
    ...
    const-string v4, "only one ContactEditorActivity instance allowed, finish old one: "
    ...
    .end local v0           #currentlistener:Lcom/android/contacts/ContactSaveService$Listener;
...
.method public static removeDeleteEndListener(Lcom/android/contacts/ContactSaveService$DeleteEndListener;)V
    .locals 1
    .parameter "listener"
    ...
    sput-object v0, Lcom/android/contacts/ContactSaveService;->sDeleteEndListener:Lcom/android/contacts/ContactSaveService$DeleteEndListener;

    .line 2152
    return-void
.end method

.method private removeMembersFromGroup(Landroid/content/ContentResolver;[JJ[III)Z
    .locals 14
    .parameter "resolver"
    .parameter "rawContactsToRemove"
    .parameter "groupId"
    ...
    .line 1974
    .local v10, isRemoveSuccess:Z
    if-nez p2, :cond_0

    .line 1975
    const-string v2, "ContactSaveService"

    const-string v3, "[removeMembersFromGroup]RawContacts to be removed is empty!"
    ...
    .line 2006
    .end local v10           #isRemoveSuccess:Z
    .local v11, isRemoveSuccess:I
    :goto_0
    return v11

    .line 1982
    .end local v11           #isRemoveSuccess:I
    .restart local v10       #isRemoveSuccess:Z
    :cond_0
    const/4 v9, 0x0
    ...
    invoke-static {v0, v13, v1}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->deleteUSIMGroupMember(III)Z
    ...
    const-string v6, "[removeMembersFromGroup]Remove failed RawContactid: "
    ...
    .line 2002
    invoke-direct/range {v2 .. v7}, Lcom/android/contacts/ContactSaveService;->removeOneMemberFromGroup(Landroid/content/ContentResolver;JJ)V

    goto :goto_2

    .end local v4           #rawContactId:J
    .end local v12           #ret:Z
    .end local v13           #simIndex:I
    :cond_2
    move v11, v10

    .line 2006
    .restart local v11       #isRemoveSuccess:I
    goto :goto_0
.end method

.method private removeOneMemberFromGroup(Landroid/content/ContentResolver;JJ)V
    .locals 5
    .parameter "resolver"
    .parameter "rawContactId"
    .parameter "groupId"
...
.method private saveContact(Landroid/content/Intent;)V
    ...
    check-cast v37, Lcom/android/contacts/model/RawContactDeltaList;

    .line 435
    .local v37, state:Lcom/android/contacts/model/RawContactDeltaList;
    ...
    .line 439
    .local v41, updatedPhotos:Landroid/os/Bundle;
    ...
    .line 444
    .local v28, lookupUri:Landroid/net/Uri;
    invoke-virtual/range {p0 .. p0}, Landroid/content/ContextWrapper;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 455
    :try_start_0
    invoke-virtual/range {v37 .. v37}, Lcom/android/contacts/model/RawContactDeltaList;->buildDiff()Ljava/util/ArrayList;

    move-result-object v18

    .line 463
    .local v18, diff:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ContentProviderOperation;>;"
    const/16 v35, 0x0

    .line 464
    .local v35, results:[Landroid/content/ContentProviderResult;
    ...
    .line 502
    .end local v18           #diff:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ContentProviderOperation;>;"
    .end local v32           #rawContactId:J
    .end local v35           #results:[Landroid/content/ContentProviderResult;
    :catch_0
    move-exception v19
    ...
    .line 559
    invoke-virtual/range {v41 .. v41}, Landroid/os/Bundle;->keySet()Ljava/util/Set;
    ...
    .line 561
    .local v31, photoFilePath:Ljava/lang/String;
    invoke-static/range {v26 .. v26}, Ljava/lang/Long;->parseLong(Ljava/lang/String;)J

    move-result-wide v32

    .line 565
    .restart local v32       #rawContactId:J
    ...
    .end local v31           #photoFilePath:Ljava/lang/String;
    .restart local v18       #diff:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ContentProviderOperation;>;"
    .restart local v35       #results:[Landroid/content/ContentProviderResult;
    :cond_3
    :try_start_1
    move-object/from16 v0, p0
    ...
    .line 486
    .local v27, lookupKey:Ljava/lang/String;
    ...
    .end local v27           #lookupKey:Ljava/lang/String;
    :cond_4
    :try_start_3
    ...
    .line 509
    .local v19, e:Landroid/content/OperationApplicationException;
    const-string v5, "ContactSaveService"
    ...
    .line 515
    .local v32, rawContactId:Ljava/lang/Long;
    if-eqz v32, :cond_6
    ...
    .end local v19           #e:Landroid/content/OperationApplicationException;
    ...
    .restart local v19       #e:Landroid/content/OperationApplicationException;
    ...
    .line 534
    .local v29, newState:Lcom/android/contacts/model/RawContactDeltaList;
    ...
    invoke-virtual {v5, v6}, Lcom/android/contacts/model/RawContactDelta$ValuesDelta;->getAsInteger(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .end local v29           #newState:Lcom/android/contacts/model/RawContactDeltaList;
    :cond_a
    ...
    .line 548
    .restart local v29       #newState:Lcom/android/contacts/model/RawContactDeltaList;
    :cond_b
    if-eqz v25, :cond_c
    ...
    .line 550
    .local v17, delta:Lcom/android/contacts/model/RawContactDelta;
    invoke-virtual/range {v17 .. v17}, Lcom/android/contacts/model/RawContactDelta;->setProfileQueryUri()V

    goto :goto_6

    .end local v17           #delta:Lcom/android/contacts/model/RawContactDelta;
    .end local v22           #i$:Ljava/util/Iterator;
    :cond_c
    move/from16 v40, v39
    ...
    .restart local v31       #photoFilePath:Ljava/lang/String;
    .restart local v32       #rawContactId:J
    .restart local v39       #tries:I
    :cond_d
    ...
    .line 574
    .local v30, photoFile:Ljava/io/File;
    move-object/from16 v0, p0
    ...
    .end local v22           #i$:Ljava/util/Iterator;
    .end local v26           #key:Ljava/lang/String;
    .end local v30           #photoFile:Ljava/io/File;
    .end local v31           #photoFilePath:Ljava/lang/String;
    .end local v32           #rawContactId:J
    :cond_e
...
.method private saveGroupIdsToContact(Landroid/content/Intent;)V
    .locals 14
    .parameter "intent"
    ...
    const-string v12, "[saveGroupIdsToContact] slotId: "
    ...
    invoke-static {v10, v11}, Lcom/mediatek/contacts/util/LogUtils;->d(Ljava/lang/String;Ljava/lang/String;)V

    .line 1075
    const-string v10, "groupMembershipName"
    ...
    .line 1077
    .local v2, mGroupMemberShipName:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const-string v10, "groupNameList"
    ...
    .line 1081
    .local v6, mSelectedGroupsNameList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    if-ltz v9, :cond_0

    invoke-static {v9}, Lcom/mediatek/contacts/simcontact/SimCardUtils;->isSimUsimType(I)Z
    ...
    .line 1082
    invoke-direct {p0, v2, v6, v8, v9}, Lcom/android/contacts/ContactSaveService;->operateUSIMGroupContacts(Ljava/util/ArrayList;Ljava/util/ArrayList;II)Z
    ...
    const-string v11, "[saveGroupIdsToContact]callbackIntent"
    ...
    .line 1086
    .local v0, callbackIntent:Landroid/content/Intent;
    const-string v10, "rawContactsId"
    ...
    .line 1094
    const-string v10, "rawContactIds"
    ...
    .line 1096
    .local v3, mRawContactId:J
    invoke-direct {p0, v7, v3, v4}, Lcom/android/contacts/ContactSaveService;->deleteDataByContactInfo([JJ)V

    .line 1099
    const-string v10, "groupIdList"
    ...
    .line 1101
    .local v5, mSelectedGroupsIdList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    invoke-direct {p0, v5, v7, v3, v4}, Lcom/android/contacts/ContactSaveService;->insertDataByNewGroupId(Ljava/util/List;[JJ)Z
    ...
    const-string v12, "[saveGroupIdsToContact],isSuccess:"
    ...
    .line 1106
    invoke-static {v9}, Lcom/mediatek/contacts/simcontact/SimCardUtils;->isSimInserted(I)Z
    ...
    const-string v11, "[saveGroupIdsToContact] Find sim removed"
    ...
    invoke-direct {p0, v10, v9}, Lcom/android/contacts/ContactSaveService;->showMoveUSIMGroupErrorToast(II)V
...
.method private setBlockVideoCall(Landroid/content/Intent;)V
    .locals 6
    .parameter "intent"
    ...
    .line 1386
    .local v0, contactUri:Landroid/net/Uri;
    const-string v3, "blockVideoCallFlag"
    ...
    const-string v4, "Invalid arguments for setBlockVideoCall"
...
.method public static setDeleteEndListener(Lcom/android/contacts/ContactSaveService$DeleteEndListener;)V
    .locals 0
    .parameter "listener"

    .prologue
    .line 2147
    sput-object p0, Lcom/android/contacts/ContactSaveService;->sDeleteEndListener:Lcom/android/contacts/ContactSaveService$DeleteEndListener;
...
.method private showMoveUSIMGroupErrorToast(II)V
    .locals 6
    .parameter "errCode"
    .parameter "slot"
    ...
    const-string v5, "[showMoveUSIMGroupErrorToast]errCode:"
    ...
    invoke-static {v3, p2}, Lcom/mediatek/contacts/simcontact/SimCardUtils;->isSetRadioOn(Landroid/content/ContentResolver;I)Z

    move-result v0

    .line 2053
    .local v0, isSetRadioOn:Z
    const/4 v3, 0x3
    ...
    const-string v5, "[showMoveUSIMGroupErrorToast]toastMsg:"
    ...
    .line 2062
    iget-object v3, p0, Lcom/android/contacts/ContactSaveService;->mMainHandler:Landroid/os/Handler;

    new-instance v4, Lcom/android/contacts/ContactSaveService$3;

    invoke-direct {v4, p0, v1}, Lcom/android/contacts/ContactSaveService$3;-><init>(Lcom/android/contacts/ContactSaveService;Ljava/lang/String;)V
    ...
    .end local v2           #toastMsg:Ljava/lang/String;
    :cond_1
    ...
    .restart local v2       #toastMsg:Ljava/lang/String;
    goto :goto_0
.end method
...
.method public static unregisterListener(Lcom/android/contacts/ContactSaveService$Listener;)V
    ...
    const-string v2, "listener removed from SaveService: "
...
.method private updateGroup(Landroid/content/Intent;)V
    ...
    .line 1133
    .local v17, simIndexToAddArray:[I
    const-string v4, "simIndexToRemove"
    ...
    .line 1134
    .local v9, simIndexToRemoveArray:[I
    ...
    .line 1135
    .local v10, slotId:I
    const-string v4, "originalGroupName"
    ...
    .line 1136
    .local v28, originalName:Ljava/lang/String;
    ...
    const-string v13, "[updateGroup]groupName:"
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/contacts/ContactSaveService;->checkGroupNameExist(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v12, "[updateGroup] Group Name exist!"

    invoke-static {v4, v12}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1146
    const-string v4, "callbackIntent"
    ...
    .line 1147
    .local v22, callbackIntent:Landroid/content/Intent;
    ...
    .line 1152
    .end local v22           #callbackIntent:Landroid/content/Intent;
    :cond_0
    const/4 v11, -0x1
    ...
    invoke-static {v10, v0, v1}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroup;->syncUSIMGroupUpdate(ILjava/lang/String;Ljava/lang/String;)I
    ...
    const-string v13, "---------ugrpId[updateGroup]"
    ...
    .line 1177
    .restart local v22       #callbackIntent:Landroid/content/Intent;
    const-string v4, "ContactSaveService"

    const-string v12, "callbackIntent"
    ...
    .line 1162
    .local v23, e:Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroupException;
    const-string v4, "ContactSaveService"
    ...
    const-string v13, "[SyncUSIMGroup] catched USIMGroupException. ErrorType: "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    invoke-virtual/range {v23 .. v23}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroupException;->getErrorType()I
    ...
    iget-object v4, v0, Lcom/android/contacts/ContactSaveService;->mSlotError:Landroid/util/SparseIntArray;

    invoke-virtual/range {v23 .. v23}, Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroupException;->getErrorSlotId()I
    ...
    invoke-virtual {v4, v12, v13}, Landroid/util/SparseIntArray;->put(II)V
    ...
    .line 1184
    .end local v22           #callbackIntent:Landroid/content/Intent;
    .end local v23           #e:Lcom/mediatek/contacts/util/ContactsGroupUtils$USIMGroupException;
    :cond_2
    const-wide/16 v12, -0x1
    ...
    const-string v12, "Invalid arguments for updateGroup request"
    ...
    .line 1195
    .local v24, groupUri:Landroid/net/Uri;
    if-eqz v27, :cond_4
    ...
    invoke-virtual {v5, v0, v1, v4, v12}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 1202
    invoke-direct/range {v4 .. v11}, Lcom/android/contacts/ContactSaveService;->removeMembersFromGroup(Landroid/content/ContentResolver;[JJ[III)Z

    move-result v26

    .line 1204
    .local v26, isRemoveSuccess:Z
    const-string v4, "ContactSaveService"
    ...
    const-string v13, "isRemoveSuccess:"
    ...
    invoke-static {v4, v12}, Lcom/mediatek/contacts/util/LogUtils;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1206
    invoke-direct/range {v12 .. v19}, Lcom/android/contacts/ContactSaveService;->addMembersToGroup(Landroid/content/ContentResolver;[JJ[III)Z

    move-result v25

    .line 1208
    .local v25, isAddSuccess:Z
    const-string v4, "ContactSaveService"
    ...
    const-string v12, "[updateGroup] Find sim removed"
    ...
    invoke-direct {v0, v4, v10}, Lcom/android/contacts/ContactSaveService;->showMoveUSIMGroupErrorToast(II)V
    ...
    .end local v24           #groupUri:Landroid/net/Uri;
    .end local v25           #isAddSuccess:Z
    .end local v26           #isRemoveSuccess:Z
    :cond_6
    :goto_2
    move-object/from16 v0, p0
    ...
    .restart local v24       #groupUri:Landroid/net/Uri;
    .restart local v25       #isAddSuccess:Z
    .restart local v26       #isRemoveSuccess:Z
    :cond_7
    const/4 v4, 0x0
    ...
    const-string v12, "createGroup(),setData == nul"

    invoke-static {v4, v12}, Lcom/mediatek/contacts/util/LogUtils;->w(Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public bufferOperations(Ljava/util/ArrayList;Landroid/content/ContentResolver;)V
    .locals 4
    .parameter
    .parameter "resolver"
    .annotation system Ldalvik/annotation/Signature;
    ...
    const-string v2, "[bufferOperatation] begin applyBatch "
    ...
    const-string v2, "[bufferOperatation] end applyBatch"
    ...
    const-string v2, "[bufferOperatation]Failed to apply aggregation exception batch"

    invoke-static {v1, v2, v0}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .line 2083
    invoke-direct {p0, v3}, Lcom/android/contacts/ContactSaveService;->showToast(I)V
...
.method deliverCallbackOnUiThread(Landroid/content/Intent;)V
    ...
    const-string v4, "service complete, notify listener: "
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    :cond_0
    :goto_0
    sput-boolean v6, Lcom/android/contacts/ContactSaveService;->mIsTransactionProcessing:Z
    ...
    const-string v4, "IllegalStateException: callbackIntent == NULL!"
    ...
    .line 270
    sput-boolean v4, Lcom/android/contacts/ContactSaveService;->mIsTransactionProcessing:Z
    ...
    .line 280
    :cond_7
    const-string v3, "saveGroupToContact"
    ...
    .line 284
    invoke-direct {p0, p1}, Lcom/android/contacts/ContactSaveService;->saveGroupIdsToContact(Landroid/content/Intent;)V

    goto/16 :goto_0

    .line 285
    :cond_8
    const-string v3, "setStarred"
    ...
    .line 287
    :cond_9
    const-string v3, "setSuperPrimary"
    ...
    .line 307
    :cond_f
    const-string v3, "blockVideoCall"
    ...
    .line 308
    invoke-direct {p0, p1}, Lcom/android/contacts/ContactSaveService;->setBlockVideoCall(Landroid/content/Intent;)V
