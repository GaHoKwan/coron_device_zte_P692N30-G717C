...
.method public onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    .line 109
    invoke-static {}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$000()Ljava/lang/String;
    ...
    #getter for: Lcom/android/contacts/list/PhoneFavoriteFragment;->mTextViewLeft:Landroid/widget/TextView;
    invoke-static {v0}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$100(Lcom/android/contacts/list/PhoneFavoriteFragment;)Landroid/widget/TextView;
    ...
    #getter for: Lcom/android/contacts/list/PhoneFavoriteFragment;->mListViewLeft:Landroid/widget/ListView;
    invoke-static {v0}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$200(Lcom/android/contacts/list/PhoneFavoriteFragment;)Landroid/widget/ListView;
    ...
    #getter for: Lcom/android/contacts/list/PhoneFavoriteFragment;->mTextViewLeft:Landroid/widget/TextView;
    invoke-static {v1}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$100(Lcom/android/contacts/list/PhoneFavoriteFragment;)Landroid/widget/TextView;
    ...
    invoke-static {v0}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$300(Lcom/android/contacts/list/PhoneFavoriteFragment;)Lcom/android/contacts/list/ContactTileAdapter;
    ...
    invoke-static {v0}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$400(Lcom/android/contacts/list/PhoneFavoriteFragment;)Z
    ...
    invoke-static {v0}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$500(Lcom/android/contacts/list/PhoneFavoriteFragment;)Lcom/android/contacts/list/PhoneNumberListAdapter;
    ...
    invoke-static {}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$600()I
    ...
    invoke-static {v2}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$700(Lcom/android/contacts/list/PhoneFavoriteFragment;)Landroid/app/LoaderManager$LoaderCallbacks;
    ...
    invoke-static {v0, v3}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$402(Lcom/android/contacts/list/PhoneFavoriteFragment;Z)Z
    ...
    invoke-static {v0, v1}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$802(Lcom/android/contacts/list/PhoneFavoriteFragment;Z)Z

    .line 144
    iget-object v0, p0, Lcom/android/contacts/list/PhoneFavoriteFragment$ContactTileLoaderListener;->this$0:Lcom/android/contacts/list/PhoneFavoriteFragment;

    #calls: Lcom/android/contacts/list/PhoneFavoriteFragment;->updateFilterHeaderView()V
    invoke-static {v0}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$900(Lcom/android/contacts/list/PhoneFavoriteFragment;)V
    ...
    #calls: Lcom/android/contacts/list/PhoneFavoriteFragment;->invalidateOptionsMenuIfNeeded()V
    ...
    invoke-static {v0}, Lcom/android/contacts/list/PhoneFavoriteFragment;->access$800(Lcom/android/contacts/list/PhoneFavoriteFragment;)Z
