...
.method public static create1D(Landroid/renderscript/RenderScript;I)Lcom/android/galaxy4/ScriptField_VpConsts;
    .locals 1
    .parameter "rs"
    .parameter "dimX"
    ...
    invoke-static {p0, p1, v0}, Lcom/android/galaxy4/ScriptField_VpConsts;->create1D(Landroid/renderscript/RenderScript;II)Lcom/android/galaxy4/ScriptField_VpConsts;
...
.method public static create1D(Landroid/renderscript/RenderScript;II)Lcom/android/galaxy4/ScriptField_VpConsts;
    .locals 2
    .parameter "rs"
    .parameter "dimX"
    .parameter "usages"
    ...
    .prologue
    .line 73
    new-instance v0, Lcom/android/galaxy4/ScriptField_VpConsts;

    invoke-direct {v0, p0}, Lcom/android/galaxy4/ScriptField_VpConsts;-><init>(Landroid/renderscript/RenderScript;)V

    .line 74
    .local v0, obj:Lcom/android/galaxy4/ScriptField_VpConsts;
...
.method public static create2D(Landroid/renderscript/RenderScript;II)Lcom/android/galaxy4/ScriptField_VpConsts;
    .locals 1
    .parameter "rs"
    .parameter "dimX"
    .parameter "dimY"
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/android/galaxy4/ScriptField_VpConsts;->create2D(Landroid/renderscript/RenderScript;III)Lcom/android/galaxy4/ScriptField_VpConsts;
...
.method public static create2D(Landroid/renderscript/RenderScript;III)Lcom/android/galaxy4/ScriptField_VpConsts;
    .locals 4
    .parameter "rs"
    .parameter "dimX"
    .parameter "dimY"
    ...
    .prologue
    .line 87
    new-instance v1, Lcom/android/galaxy4/ScriptField_VpConsts;

    invoke-direct {v1, p0}, Lcom/android/galaxy4/ScriptField_VpConsts;-><init>(Landroid/renderscript/RenderScript;)V

    .line 88
    .local v1, obj:Lcom/android/galaxy4/ScriptField_VpConsts;
...
.method public static createCustom(Landroid/renderscript/RenderScript;Landroid/renderscript/Type$Builder;I)Lcom/android/galaxy4/ScriptField_VpConsts;
    .locals 4
    .parameter "rs"
    .parameter "tb"
    .parameter "usages"
...
.method public static createTypeBuilder(Landroid/renderscript/RenderScript;)Landroid/renderscript/Type$Builder;
    ...
    .prologue
    .line 97
    invoke-static {p0}, Lcom/android/galaxy4/ScriptField_VpConsts;->createElement(Landroid/renderscript/RenderScript;)Landroid/renderscript/Element;
...
.method public declared-synchronized copyAll()V
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/galaxy4/ScriptField_VpConsts;->copyToArray(Lcom/android/galaxy4/ScriptField_VpConsts$Item;I)V
    ...
    iget-object v3, p0, Lcom/android/galaxy4/ScriptField_VpConsts;->mIOBuffer:Landroid/renderscript/FieldPacker;
...
.method public declared-synchronized get(I)Lcom/android/galaxy4/ScriptField_VpConsts$Item;
    .locals 1
    .parameter "index"
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/galaxy4/ScriptField_VpConsts;->mItemArray:[Lcom/android/galaxy4/ScriptField_VpConsts$Item;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized get_MVP(I)Landroid/renderscript/Matrix4f;
    ...
    iget-object v0, v0, Lcom/android/galaxy4/ScriptField_VpConsts$Item;->MVP:Landroid/renderscript/Matrix4f;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized get_scaleSize(I)F
    ...
    iget v0, v0, Lcom/android/galaxy4/ScriptField_VpConsts$Item;->scaleSize:F
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized resize(I)V
    ...
    :try_start_0
    iget-object v3, p0, Lcom/android/galaxy4/ScriptField_VpConsts;->mItemArray:[Lcom/android/galaxy4/ScriptField_VpConsts$Item;
    ...
    :cond_1
    :try_start_1
    new-array v1, p1, [Lcom/android/galaxy4/ScriptField_VpConsts$Item;

    .line 190
    .local v1, ni:[Lcom/android/galaxy4/ScriptField_VpConsts$Item;
    iget-object v3, p0, Lcom/android/galaxy4/ScriptField_VpConsts;->mItemArray:[Lcom/android/galaxy4/ScriptField_VpConsts$Item;
    ...
    .line 194
    .end local v0           #copySize:I
    .end local v1           #ni:[Lcom/android/galaxy4/ScriptField_VpConsts$Item;
    .end local v2           #oldSize:I
    :cond_2
    ...
    iput-object v3, p0, Lcom/android/galaxy4/ScriptField_VpConsts;->mIOBuffer:Landroid/renderscript/FieldPacker;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized set_MVP(ILandroid/renderscript/Matrix4f;Z)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/galaxy4/ScriptField_VpConsts;->mIOBuffer:Landroid/renderscript/FieldPacker;
    ...
    iput-object v1, p0, Lcom/android/galaxy4/ScriptField_VpConsts;->mIOBuffer:Landroid/renderscript/FieldPacker;
    ...
    new-instance v2, Lcom/android/galaxy4/ScriptField_VpConsts$Item;

    invoke-direct {v2}, Lcom/android/galaxy4/ScriptField_VpConsts$Item;-><init>()V
    ...
    iput-object p2, v1, Lcom/android/galaxy4/ScriptField_VpConsts$Item;->MVP:Landroid/renderscript/Matrix4f;
...
.method public declared-synchronized set_scaleSize(IFZ)V
    ...
    iput p2, v1, Lcom/android/galaxy4/ScriptField_VpConsts$Item;->scaleSize:F
