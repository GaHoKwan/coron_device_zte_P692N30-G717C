...
# static fields
.field private static final APPLICAITON_AUTHORITY:Ljava/lang/String; = "applications"
...
.method private static createIntent(Lcom/android/quicksearchbox/SuggestionCursor;Landroid/os/Bundle;)Landroid/content/Intent;
    .locals 8
    ...
    .line 107
    :cond_3
    invoke-interface {p0}, Lcom/android/quicksearchbox/SuggestionCursor;->isWebSearchSuggestion()Z
...
.method private static getAppIntent(Lcom/android/quicksearchbox/SuggestionCursor;)Landroid/content/Intent;
    .locals 6
    .parameter "suggestion"
    ...
    .line 54
    invoke-interface {p0}, Lcom/android/quicksearchbox/SuggestionCursor;->getSuggestionSource()Lcom/android/quicksearchbox/Source;

    move-result-object v4

    .line 55
    .local v4, source:Lcom/android/quicksearchbox/Source;
    invoke-interface {v4}, Lcom/android/quicksearchbox/Source;->getSuggestAuthority()Ljava/lang/String;
    ...
    invoke-static {v5}, Landroid/provider/Applications;->uriToComponentName(Landroid/net/Uri;)Landroid/content/ComponentName;
...
.method public static getSuggestionIntent(Lcom/android/quicksearchbox/SuggestionCursor;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    .prologue
    .line 46
    invoke-static {p0}, Lcom/android/quicksearchbox/SuggestionUtils;->getAppIntent(Lcom/android/quicksearchbox/SuggestionCursor;)Landroid/content/Intent;
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/android/quicksearchbox/SuggestionUtils;->createIntent(Lcom/android/quicksearchbox/SuggestionCursor;Landroid/os/Bundle;)Landroid/content/Intent;
