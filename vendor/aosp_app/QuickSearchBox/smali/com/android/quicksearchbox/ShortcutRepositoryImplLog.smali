...
.field private static final DB_NAME:Ljava/lang/String; = "qsb-log.db"

.field private static final DB_VERSION:I = 0x20

.field private static final GROUP_BY:Ljava/lang/String; = null

.field private static final HAS_HISTORY_QUERY:Ljava/lang/String; = null

.field private static final LAST_HIT_TIME_EXPR:Ljava/lang/String; = null

.field private static final PREFER_LATEST_PREFIX:Ljava/lang/String; = null

.field private static final PREFER_LATEST_SUFFIX:Ljava/lang/String; = "))"

.field private static final PREFIX_RESTRICTION:Ljava/lang/String; = null

.field private static final SHORTCUT_BY_ID_WHERE:Ljava/lang/String; = null

.field private static final SHORTCUT_QUERY_COLUMNS:[Ljava/lang/String; = null

.field private static final SOURCE_RANKING_SQL:Ljava/lang/String; = null

.field private static final TABLES:Ljava/lang/String; = null

.field private static final TAG:Ljava/lang/String; = "QSB.ShortcutRepositoryImplLog"
...
.field private mShortcutNoQuery:Ljava/lang/String;
...
.method private buildShortcutQueries()V
    ...
    sget-object v2, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->LAST_HIT_TIME_EXPR:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->mShortcutNoQuery:Ljava/lang/String;
    ...
    const-string v4, "Shortcut no query:\n"

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v4, p0, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->mShortcutNoQuery:Ljava/lang/String;
...
.method public getCorpusScores(Lcom/android/quicksearchbox/util/Consumer;)V
    ...
    new-instance v0, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$8;

    invoke-direct {v0, p0}, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$8;-><init>(Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;)V
...
.method getShortcutsNoQuery(Ljava/util/Collection;ZJ)Lcom/android/quicksearchbox/ShortcutCursor;
    .locals 17
    .parameter
    .parameter "allowWebSearchShortcuts"
    .parameter "now"
    ...
    .prologue
    .line 387
    .local p1, allowedCorpora:Ljava/util/Collection;,"Ljava/util/Collection<Lcom/android/quicksearchbox/Corpus;>;"
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->mShortcutNoQuery:Ljava/lang/String;
    ...
    invoke-static {v2, v0, v1}, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->buildShortcutQueryParams(Ljava/lang/String;J)[Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->mOpenHelper:Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$DbOpenHelper;
    ...
    invoke-virtual {v11, v0, v14}, Landroid/database/sqlite/SQLiteDatabase;->rawQuery(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 399
    .local v8, allowedSources:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/quicksearchbox/Source;>;"
    ...
    check-cast v9, Lcom/android/quicksearchbox/Corpus;

    .line 400
    .local v9, corpus:Lcom/android/quicksearchbox/Corpus;
    invoke-interface {v9}, Lcom/android/quicksearchbox/Corpus;->getSources()Ljava/util/Collection;
    ...
    check-cast v15, Lcom/android/quicksearchbox/Source;

    .line 402
    .local v15, source:Lcom/android/quicksearchbox/Source;
    invoke-interface {v15}, Lcom/android/quicksearchbox/Source;->getName()Ljava/lang/String;
    ...
    .line 406
    .end local v9           #corpus:Lcom/android/quicksearchbox/Corpus;
    .end local v13           #i$:Ljava/util/Iterator;
    .end local v15           #source:Lcom/android/quicksearchbox/Source;
    :cond_2
    new-instance v2, Lcom/android/quicksearchbox/ShortcutCursor;

    new-instance v3, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$SuggestionCursorImpl;

    const-string v4, ""

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v8, v4, v10}, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$SuggestionCursorImpl;-><init>(Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;Ljava/util/HashMap;Ljava/lang/String;Landroid/database/Cursor;)V

    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->mUiThread:Landroid/os/Handler;

    move-object/from16 v0, p0

    iget-object v6, v0, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->mRefresher:Lcom/android/quicksearchbox/ShortcutRefresher;

    move/from16 v4, p2

    move-object/from16 v7, p0

    invoke-direct/range {v2 .. v7}, Lcom/android/quicksearchbox/ShortcutCursor;-><init>(Lcom/android/quicksearchbox/SuggestionCursor;ZLandroid/os/Handler;Lcom/android/quicksearchbox/ShortcutRefresher;Lcom/android/quicksearchbox/ShortcutRepository;)V

    goto :goto_0
.end method

.method public getShortcutsNoQuery(Ljava/util/Collection;ZLcom/android/quicksearchbox/util/Consumer;)V
    .locals 8
    .parameter
    .parameter "allowWebSearchShortcuts"
    .parameter
    ...
    .line 309
    .local p1, allowedCorpora:Ljava/util/Collection;,"Ljava/util/Collection<Lcom/android/quicksearchbox/Corpus;>;"
    .local p3, consumer:Lcom/android/quicksearchbox/util/Consumer;,"Lcom/android/quicksearchbox/util/Consumer<Lcom/android/quicksearchbox/ShortcutCursor;>;"
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    .line 310
    .local v4, now:J
    iget-object v7, p0, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;->mLogExecutor:Ljava/util/concurrent/Executor;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$7;-><init>(Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;Ljava/util/Collection;ZJLcom/android/quicksearchbox/util/Consumer;)V
...
.method refreshShortcut(Lcom/android/quicksearchbox/Source;Ljava/lang/String;Lcom/android/quicksearchbox/SuggestionCursor;)V
    ...
    :goto_0
    new-instance v2, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$9;

    invoke-direct {v2, p0, v0, p2, v1}, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$9;-><init>(Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)V
...
.method reportClickAtTime(Lcom/android/quicksearchbox/SuggestionCursor;IJ)V
    ...
    .line 742
    new-instance v4, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$10;

    invoke-direct {v4, p0, v3, v0}, Lcom/android/quicksearchbox/ShortcutRepositoryImplLog$10;-><init>(Lcom/android/quicksearchbox/ShortcutRepositoryImplLog;Landroid/content/ContentValues;Landroid/content/ContentValues;)V
