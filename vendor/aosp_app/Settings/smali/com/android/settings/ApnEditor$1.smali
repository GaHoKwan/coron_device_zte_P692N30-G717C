...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v1, v2}, Lcom/android/settings/ApnEditor;->access$002(Lcom/android/settings/ApnEditor;Z)Z

    .line 199
    iget-object v1, p0, Lcom/android/settings/ApnEditor$1;->this$0:Lcom/android/settings/ApnEditor;

    #getter for: Lcom/android/settings/ApnEditor;->mAirplaneModeEnabled:Z
    invoke-static {v1}, Lcom/android/settings/ApnEditor;->access$000(Lcom/android/settings/ApnEditor;)Z
    ...
    invoke-static {v1}, Lcom/android/settings/ApnEditor;->access$100(Lcom/android/settings/ApnEditor;)V
    ...
    invoke-static {v1, v3}, Lcom/android/settings/ApnEditor;->access$202(Lcom/android/settings/ApnEditor;Z)Z
    ...
    #setter for: Lcom/android/settings/ApnEditor;->mNotInMmsTransaction:Z
    invoke-static {v1, v2}, Lcom/android/settings/ApnEditor;->access$202(Lcom/android/settings/ApnEditor;Z)Z

    .line 210
    iget-object v1, p0, Lcom/android/settings/ApnEditor$1;->this$0:Lcom/android/settings/ApnEditor;

    #calls: Lcom/android/settings/ApnEditor;->setScreenEnabledStatus()V
    invoke-static {v1}, Lcom/android/settings/ApnEditor;->access$300(Lcom/android/settings/ApnEditor;)V
    ...
    invoke-static {v2}, Lcom/android/settings/ApnEditor;->access$400(Lcom/android/settings/ApnEditor;)Lcom/mediatek/apn/ApnTypePreference;
    ...
    iget-object v1, v1, Lcom/android/settings/ApnEditor;->mExt:Lcom/mediatek/settings/ext/IApnSettingsExt;
    ...
    invoke-static {v1, v2}, Lcom/android/settings/ApnEditor;->access$502(Lcom/android/settings/ApnEditor;I)I
    ...
    invoke-static {v3}, Lcom/android/settings/ApnEditor;->access$500(Lcom/android/settings/ApnEditor;)I
    ...
    #getter for: Lcom/android/settings/ApnEditor;->mDualSimMode:I
    invoke-static {v1}, Lcom/android/settings/ApnEditor;->access$500(Lcom/android/settings/ApnEditor;)I
    ...
    invoke-static {v1}, Lcom/android/settings/ApnEditor;->access$700(Lcom/android/settings/ApnEditor;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/settings/ApnEditor;->access$800(Lcom/android/settings/ApnEditor;)I
    ...
    #setter for: Lcom/android/settings/ApnEditor;->mSpn:Ljava/lang/String;
    invoke-static {v1, v2}, Lcom/android/settings/ApnEditor;->access$702(Lcom/android/settings/ApnEditor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/settings/ApnEditor;->access$900(Lcom/android/settings/ApnEditor;)Ljava/lang/String;
    ...
    #setter for: Lcom/android/settings/ApnEditor;->mIMSI:Ljava/lang/String;
    invoke-static {v1, v2}, Lcom/android/settings/ApnEditor;->access$902(Lcom/android/settings/ApnEditor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/settings/ApnEditor;->access$1000(Lcom/android/settings/ApnEditor;)Ljava/lang/String;
    ...
    #setter for: Lcom/android/settings/ApnEditor;->mPnn:Ljava/lang/String;
    invoke-static {v1, v2}, Lcom/android/settings/ApnEditor;->access$1002(Lcom/android/settings/ApnEditor;Ljava/lang/String;)Ljava/lang/String;
    ...
    #calls: Lcom/android/settings/ApnEditor;->dealWithSimHotSwap()V
    invoke-static {v1}, Lcom/android/settings/ApnEditor;->access$1100(Lcom/android/settings/ApnEditor;)V
