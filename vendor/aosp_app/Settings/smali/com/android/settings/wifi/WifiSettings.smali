...
.method private constructAccessPoints()Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/android/settings/wifi/AccessPoint;->bssid:Ljava/lang/String;

    move-object/from16 v18, v0

    iget-boolean v0, v2, Lcom/android/settings/wifi/AccessPoint;->mSupportedPasspoint:Z
...
.method private sameSsidCheck(Landroid/net/wifi/WifiConfiguration;)Z
    .locals 7
    .parameter "conconfig"
...
.method private updateConnectionState(Landroid/net/NetworkInfo$DetailedState;)V
    ...
    .line 1165
    :cond_3
    iget-object v3, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/mediatek/settings/ext/IWifiSettingsExt;
    ...
    .line 1167
    iget-object v3, p0, Lcom/android/settings/wifi/WifiSettings;->mTrustAPCategory:Landroid/preference/PreferenceCategory;

    invoke-virtual {p0, v3}, Lcom/android/settings/wifi/WifiSettings;->updateAP(Landroid/preference/PreferenceCategory;)V

    .line 1168
    iget-object v3, p0, Lcom/android/settings/wifi/WifiSettings;->mConfigedAPCategory:Landroid/preference/PreferenceCategory;

    invoke-virtual {p0, v3}, Lcom/android/settings/wifi/WifiSettings;->updateAP(Landroid/preference/PreferenceCategory;)V

    .line 1169
    iget-object v3, p0, Lcom/android/settings/wifi/WifiSettings;->mNewAPCategory:Landroid/preference/PreferenceCategory;
    ...
    .line 1183
    iget-boolean v3, p0, Lcom/android/settings/wifi/WifiSettings;->mManuallyConnect:Z
    ...
    .line 1186
    :cond_5
    iput-boolean v5, p0, Lcom/android/settings/wifi/WifiSettings;->mManuallyConnect:Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v8, p0, Lcom/android/settings/wifi/WifiSettings;->mTrustAPCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v8, p0, Lcom/android/settings/wifi/WifiSettings;->mConfigedAPCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v8, p0, Lcom/android/settings/wifi/WifiSettings;->mNewAPCategory:Landroid/preference/PreferenceCategory;

    .line 457
    iget-object v8, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/mediatek/settings/ext/IWifiSettingsExt;

    iget-object v9, p0, Lcom/android/settings/wifi/WifiSettings;->mTrustAPCategory:Landroid/preference/PreferenceCategory;

    iget-object v10, p0, Lcom/android/settings/wifi/WifiSettings;->mConfigedAPCategory:Landroid/preference/PreferenceCategory;

    iget-object v11, p0, Lcom/android/settings/wifi/WifiSettings;->mNewAPCategory:Landroid/preference/PreferenceCategory;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 280
    new-instance v4, Lcom/android/settings/wifi/WifiSettings$3;

    invoke-direct {v4, p0, p1, v0}, Lcom/android/settings/wifi/WifiSettings$3;-><init>(Lcom/android/settings/wifi/WifiSettings;Landroid/view/LayoutInflater;Landroid/widget/ImageButton;)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    iget-boolean v3, v3, Lcom/android/settings/wifi/AccessPoint;->mSupportedPasspoint:Z
...
.method submit(Lcom/android/settings/wifi/WifiConfigController;)V
    ...
    :try_start_0
    iget-object v7, v1, Landroid/net/wifi/WifiConfiguration;->imsi:Ljava/lang/String;
    ...
    const-string v9, "submit exception() "
    ...
    const-string v9, "mSelectedAccessPoint "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/settings/wifi/WifiSettings;->mSelectedAccessPoint:Lcom/android/settings/wifi/AccessPoint;
    ...
    const-string v8, "onClick() >>if ((mConfig.SSID).equals(mSelectedAccessPoint.ssid)) {"
    ...
    invoke-static {v8}, Lcom/android/settings/wifi/WifiDialog;->addQuote(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, "remind user: cannot user eap-sim/aka under airplane mode"
    ...
    invoke-static {v7, v13, v10}, Landroid/widget/Toast;->makeText(Landroid/content/Context;II)Landroid/widget/Toast;
    ...
    invoke-direct {p0, v7}, Lcom/android/settings/wifi/WifiSettings;->requireKeyStore(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    iget-object v9, p0, Lcom/android/settings/wifi/WifiSettings;->mConnectListener:Landroid/net/wifi/WifiManager$ActionListener;

    invoke-virtual {v7, v8, v9}, Landroid/net/wifi/WifiManager;->connect(ILandroid/net/wifi/WifiManager$ActionListener;)V

    .line 1356
    iput-boolean v10, p0, Lcom/android/settings/wifi/WifiSettings;->mManuallyConnect:Z
    ...
    invoke-interface {v7, v1}, Lcom/mediatek/settings/ext/IWifiSettingsExt;->setLastConnectedConfig(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {v7}, Lcom/android/settings/wifi/WifiSettings$Scanner;->resume()V
    ...
    .line 1359
    .restart local v2       #configs:Ljava/util/List;,"Ljava/util/List<Landroid/net/wifi/WifiConfiguration;>;"
    .restart local v6       #state:Landroid/net/NetworkInfo$DetailedState;
    :cond_9
    iget-object v7, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/mediatek/settings/ext/IWifiSettingsExt;
    ...
    invoke-interface {v7, v8}, Lcom/mediatek/settings/ext/IWifiSettingsExt;->disconnect(I)V
    ...
    invoke-interface {v7, v1}, Lcom/mediatek/settings/ext/IWifiSettingsExt;->setNewPriority(Landroid/net/wifi/WifiConfiguration;)V

    .line 1367
    iget-object v7, p0, Lcom/android/settings/wifi/WifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;

    iget-object v8, p0, Lcom/android/settings/wifi/WifiSettings;->mSaveListener:Landroid/net/wifi/WifiManager$ActionListener;
    ...
    .line 1371
    :cond_b
    invoke-direct {p0, v1}, Lcom/android/settings/wifi/WifiSettings;->sameSsidCheck(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    invoke-interface {v7, v1}, Lcom/mediatek/settings/ext/IWifiSettingsExt;->updatePriorityAfterSubmit(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {v7, v1, v8}, Landroid/net/wifi/WifiManager;->connect(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiManager$ActionListener;)V
