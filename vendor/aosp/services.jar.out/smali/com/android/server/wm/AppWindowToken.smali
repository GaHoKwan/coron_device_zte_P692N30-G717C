...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;ILandroid/view/IApplicationToken;)V
    ...
    .line 56
    iput v4, p0, Lcom/android/server/wm/AppWindowToken;->groupId:I
    ...
    iput-object v0, p0, Lcom/android/server/wm/AppWindowToken;->mMagnificationSpec:Lcom/android/server/wm/MagnificationSpec;
    ...
    .line 143
    iget-object v0, p0, Lcom/android/server/wm/AppWindowToken;->mMagnificationSpec:Lcom/android/server/wm/MagnificationSpec;

    const/high16 v1, 0x3f80

    invoke-virtual {v0, v1, v3, v3}, Lcom/android/server/wm/MagnificationSpec;->initialize(FFF)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/AppWindowToken;->mSmartShowContext:Lcom/android/server/FullSmartShowContext;
...
.method getDisplayId()I
    ...
    .prologue
    .line 154
    invoke-super {p0}, Lcom/android/server/wm/WindowToken;->getDisplayId()I
...
.method getMagnificationSpec()Lcom/android/server/wm/MagnificationSpec;
    .locals 1
...
.method getSmartShowData(Ljava/lang/Object;)Ljava/lang/Object;
    .locals 1
    .parameter "obj"

    .prologue
    .line 162
    iget-object v0, p0, Lcom/android/server/wm/AppWindowToken;->mSmartShowData:Ljava/lang/Object;

    return-object v0
.end method

.method getSrcDisplayId()I
    .locals 1

    .prologue
    .line 166
    iget v0, p0, Lcom/android/server/wm/AppWindowToken;->mSrcDisplayId:I
...
.method isDefaultDisplay()Z
    ...
    .prologue
    .line 178
    invoke-super {p0}, Lcom/android/server/wm/WindowToken;->isDefaultDisplay()Z
...
.method saveMagnificationSpec(FFF)V
    .locals 1
    .parameter "scale"
    .parameter "xoffset"
    .parameter "yoffset"
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/wm/MagnificationSpec;->initialize(FFF)V
...
.method setDisplayId(I)V
    ...
    .prologue
    .line 148
    invoke-super {p0, p1}, Lcom/android/server/wm/WindowToken;->setDisplayId(I)V

    .line 149
    iget-object v0, p0, Lcom/android/server/wm/AppWindowToken;->mInputApplicationHandle:Lcom/android/server/input/InputApplicationHandle;

    invoke-virtual {v0, p1}, Lcom/android/server/input/InputApplicationHandle;->setDisplayId(I)V

    .line 150
    invoke-virtual {p0}, Lcom/android/server/wm/AppWindowToken;->updateSrcDisplayId()V

    .line 151
    return-void
.end method

.method setSmartShowData(Ljava/lang/Object;)V
    .locals 0
    .parameter "obj"

    .prologue
    .line 158
    iput-object p1, p0, Lcom/android/server/wm/AppWindowToken;->mSmartShowData:Ljava/lang/Object;
...
.method updateSrcDisplayId()V
    ...
    .line 171
    invoke-virtual {p0}, Lcom/android/server/wm/AppWindowToken;->getDisplayId()I

    move-result v0

    iput v0, p0, Lcom/android/server/wm/AppWindowToken;->mSrcDisplayId:I
    ...
    .line 173
    :cond_0
    iget-object v0, p0, Lcom/android/server/wm/AppWindowToken;->mSmartShowContext:Lcom/android/server/FullSmartShowContext;

    const/4 v1, 0x0

    iget-object v2, p0, Lcom/android/server/wm/AppWindowToken;->mSmartShowData:Ljava/lang/Object;
