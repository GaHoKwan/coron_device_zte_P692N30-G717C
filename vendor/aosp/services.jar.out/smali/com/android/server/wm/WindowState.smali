...
.field private mDisplayToken:Lcom/android/server/wm/AppWindowToken;
...
.field private mOriginalDisplayId:I

.field private mOriginalDisplayInfo:Landroid/view/DisplayInfo;
...
.field private mSmartShowData:Ljava/lang/Object;

.field mStartedDisplayId:I

.field final mStartedSystemDecorRect:Landroid/graphics/Rect;

.field mStringNameCache:Ljava/lang/String;

.field private mStub:Lcom/android/server/wm/IWmSmartShowStub;
...
.field private mWindowDisplayId:I
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;ILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    .line 111
    new-instance v6, Lcom/android/server/wm/MagnificationSpec;

    invoke-direct {v6}, Lcom/android/server/wm/MagnificationSpec;-><init>()V

    iput-object v6, p0, Lcom/android/server/wm/WindowState;->mMagnificationSpec:Lcom/android/server/wm/MagnificationSpec;

    .line 112
    const/4 v6, -0x1

    iput v6, p0, Lcom/android/server/wm/WindowState;->mStartedDisplayId:I
    ...
    iput-object v6, p0, Lcom/android/server/wm/WindowState;->mStartedSystemDecorRect:Landroid/graphics/Rect;
    ...
    iput v6, p0, Lcom/android/server/wm/WindowState;->mOriginalDisplayId:I

    .line 287
    const/4 v6, 0x0

    iput-object v6, p0, Lcom/android/server/wm/WindowState;->mOriginalDisplayInfo:Landroid/view/DisplayInfo;

    .line 288
    const/4 v6, 0x0

    iput-object v6, p0, Lcom/android/server/wm/WindowState;->mSmartShowContext:Lcom/android/server/FullSmartShowContext;

    .line 289
    const/4 v6, 0x0

    iput-boolean v6, p0, Lcom/android/server/wm/WindowState;->mTmpHidden:Z

    .line 291
    const/4 v6, -0x1

    iput v6, p0, Lcom/android/server/wm/WindowState;->mLastSrcDisplayId:I

    .line 294
    const/4 v6, 0x0

    iput v6, p0, Lcom/android/server/wm/WindowState;->mWindowDisplayId:I
    ...
    check-cast v6, Lcom/android/server/FullSmartShowContext;
    ...
    .line 429
    iget-object v6, p0, Lcom/android/server/wm/WindowState;->mMagnificationSpec:Lcom/android/server/wm/MagnificationSpec;
    ...
    invoke-virtual {v6, v7, v8, v9}, Lcom/android/server/wm/MagnificationSpec;->initialize(FFF)V

    .line 430
    iget-object v6, p0, Lcom/android/server/wm/WindowState;->mSmartShowContext:Lcom/android/server/FullSmartShowContext;

    invoke-virtual {v6, p0}, Lcom/android/server/FullSmartShowContext;->getSmartShowData(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    iput-object v6, p0, Lcom/android/server/wm/WindowState;->mSmartShowData:Ljava/lang/Object;

    .line 431
    iget-object v6, p0, Lcom/android/server/wm/WindowState;->mSmartShowContext:Lcom/android/server/FullSmartShowContext;

    invoke-virtual {v6}, Lcom/android/server/FullSmartShowContext;->getWmSmartShowStub()Lcom/android/server/wm/IWmSmartShowStub;

    move-result-object v6

    iput-object v6, p0, Lcom/android/server/wm/WindowState;->mStub:Lcom/android/server/wm/IWmSmartShowStub;
...
# virtual methods
.method public adjustWindowMagnificationLocked(IIIILandroid/graphics/Rect;)F
    .locals 12
    .parameter "srcWidth"
    .parameter "srcHeight"
    .parameter "dstWidth"
    ...
    .line 488
    .local v6, logicalWidth:I
    move v5, p2

    .line 489
    .local v5, logicalHeight:I
    move v8, p3

    .line 490
    .local v8, physWidth:I
    move/from16 v7, p4

    .line 492
    .local v7, physHeight:I
    ...
    .line 508
    .local v3, displayRectTop:I
    sub-int v10, v8, v4

    div-int/lit8 v2, v10, 0x2

    .line 510
    .local v2, displayRectLeft:I
    add-int v10, v2, v4
    ...
    invoke-virtual {v0, v2, v3, v10, v11}, Landroid/graphics/Rect;->set(IIII)V

    .line 511
    return v9

    .line 502
    .end local v1           #displayRectHeight:I
    .end local v2           #displayRectLeft:I
    .end local v3           #displayRectTop:I
    ...
    .line 504
    .restart local v1       #displayRectHeight:I
    int-to-float v10, v7
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/WindowManagerService;->hasExternalDisplay()Z
    ...
    iget-object v2, v0, Lcom/android/server/wm/WindowState;->mStub:Lcom/android/server/wm/IWmSmartShowStub;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/wm/WindowState;->mSmartShowData:Ljava/lang/Object;
    ...
    invoke-interface/range {v2 .. v7}, Lcom/android/server/wm/IWmSmartShowStub;->beginComputeFrame(Ljava/lang/Object;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    iget-object v6, v0, Lcom/android/server/wm/WindowState;->mSmartShowData:Ljava/lang/Object;

    invoke-interface {v2, v6}, Lcom/android/server/wm/IWmSmartShowStub;->finishComputeFrame(Ljava/lang/Object;)V
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    .line 1366
    const-string v1, " mOriginalDisplayId="

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v1, p0, Lcom/android/server/wm/WindowState;->mOriginalDisplayId:I

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->print(I)V

    .line 1367
    const-string v1, " mWindowDisplayId="

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->getWindowDisplayId()I
    ...
    const-string v1, "mSrcDisplayId="

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->getSrcDisplayId()I
    ...
    const-string v1, "isForcedOrientation="

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->isForcedOrientation()Z
    ...
    .line 1372
    const-string v1, " isLauchedFromDefault="

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->isLauchedFromDefault()Z
    ...
    .line 1389
    const-string v1, "mIsFloatingWindow="
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->getDisplayToken()Lcom/android/server/wm/AppWindowToken;
    ...
    .line 1517
    :cond_1f
    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mMagnificationSpec:Lcom/android/server/wm/MagnificationSpec;
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->getWindowMagnificationSpecLocked()Lcom/android/server/wm/MagnificationSpec;
...
.method public getAppSmartShowData()Ljava/lang/Object;
    .locals 2
    ...
    .line 862
    invoke-virtual {v0, v1}, Lcom/android/server/wm/AppWindowToken;->getSmartShowData(Ljava/lang/Object;)Ljava/lang/Object;
...
.method getDisplayMagnificationSpecLocked()Lcom/android/server/wm/MagnificationSpec;
    .locals 4
    ...
    iget v3, p0, Lcom/android/server/wm/WindowState;->mOriginalDisplayId:I

    invoke-virtual {v2, v3}, Lcom/android/server/wm/DisplayContent;->getMagnificationSpec(I)Lcom/android/server/wm/MagnificationSpec;
...
.method public getDisplayToken()Lcom/android/server/wm/AppWindowToken;
    .locals 2
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mDisplayToken:Lcom/android/server/wm/AppWindowToken;

    goto :goto_0
.end method

.method public getDstDisplayId()I
    .locals 1

    .prologue
    .line 843
    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->getOriginalDisplayId()I
...
.method public getOriginalDisplayId()I
    .locals 1

    .prologue
    .line 839
    iget v0, p0, Lcom/android/server/wm/WindowState;->mOriginalDisplayId:I

    return v0
.end method

.method public getOverrideDisplayId()I
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowToken;->getDisplayId()I
...
.method public getSmartShowData()Ljava/lang/Object;
    .locals 1

    .prologue
    .line 856
    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mSmartShowData:Ljava/lang/Object;

    return-object v0
.end method

.method public getSrcDisplayId()I
    .locals 2
    ...
    .line 849
    invoke-virtual {v0}, Lcom/android/server/wm/AppWindowToken;->getSrcDisplayId()I
...
.method public getStartedDisplayId(I)I
    .locals 1
    .parameter "displayId"

    .prologue
    .line 472
    iget v0, p0, Lcom/android/server/wm/WindowState;->mStartedDisplayId:I
...
.method public getTouchableRegion(Landroid/graphics/Region;)V
    ...
    .line 1357
    :goto_0
    iget-object v2, p0, Lcom/android/server/wm/WindowState;->mStub:Lcom/android/server/wm/IWmSmartShowStub;

    iget-object v3, p0, Lcom/android/server/wm/WindowState;->mSmartShowData:Ljava/lang/Object;

    invoke-interface {v2, v3, p1}, Lcom/android/server/wm/IWmSmartShowStub;->adjustTouchRegion(Ljava/lang/Object;Landroid/graphics/Region;)V
...
.method public getWindowDisplayId()I
    .locals 1

    .prologue
    .line 456
    iget v0, p0, Lcom/android/server/wm/WindowState;->mWindowDisplayId:I
...
.method public getWindowMagnificationSpecLocked()Lcom/android/server/wm/MagnificationSpec;
    .locals 4
    ...
    .line 687
    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mMagnificationSpec:Lcom/android/server/wm/MagnificationSpec;
    ...
    .line 689
    :cond_0
    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mStub:Lcom/android/server/wm/IWmSmartShowStub;

    iget-object v2, p0, Lcom/android/server/wm/WindowState;->mSmartShowData:Ljava/lang/Object;

    invoke-interface {v1, v2}, Lcom/android/server/wm/IWmSmartShowStub;->getWindowMagnificationSpec(Ljava/lang/Object;)Lcom/android/server/wm/MagnificationSpec;
...
.method hideLw(ZZ)Z
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/wm/DisplayContent;->getCurrentFocus(I)Lcom/android/server/wm/WindowState;
...
.method public isClipNeeded()Z
    .locals 2

    .prologue
    .line 297
    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mStub:Lcom/android/server/wm/IWmSmartShowStub;

    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mSmartShowData:Ljava/lang/Object;

    invoke-interface {v0, v1}, Lcom/android/server/wm/IWmSmartShowStub;->isClipNeeded(Ljava/lang/Object;)Z
...
.method public isDefaultExternalDisplay()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/DisplayContent;->isDefaultExternalDisplay()Z
...
.method isFloatingWindow()Z
    ...
    invoke-interface {v0, v1}, Lcom/android/server/wm/IWmSmartShowStub;->isFloatingWindow(Ljava/lang/Object;)Z
...
.method public isForcedOrientation()Z
    .locals 8
    ...
    iget v3, v3, Lcom/android/server/wm/WindowManagerService;->mDebugForceOrientation:I
    ...
    iget v4, p0, Lcom/android/server/wm/WindowState;->mOriginalDisplayId:I
    ...
    iget v0, v3, Landroid/view/WindowManager$LayoutParams;->screenOrientation:I
...
.method isSmartBar()Z
    ...
    invoke-interface {v0, v1}, Lcom/android/server/wm/IWmSmartShowStub;->isSmartBar(Ljava/lang/Object;)Z
...
.method public isThumbnailExternalDisplay()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/DisplayContent;->isThumbnailExternalDisplay()Z
...
.method public setDisplayToken(Lcom/android/server/wm/AppWindowToken;)V
    .locals 0
    .parameter "token"

    .prologue
    .line 829
    iput-object p1, p0, Lcom/android/server/wm/WindowState;->mDisplayToken:Lcom/android/server/wm/AppWindowToken;
...
.method setOriginalDisplayId(I)V
    .locals 2
    .parameter "displayId"

    .prologue
    .line 442
    iput p1, p0, Lcom/android/server/wm/WindowState;->mOriginalDisplayId:I
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/WindowToken;->setDisplayId(I)V

    .line 449
    :cond_0
    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->updateWindowDisplay()V
    ...
    iput-boolean v1, v0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceNeedClip:Z
...
.method setStartedDisplayId(I)V
    .locals 0
    .parameter "displayId"

    .prologue
    .line 468
    iput p1, p0, Lcom/android/server/wm/WindowState;->mStartedDisplayId:I

    .line 469
    return-void
.end method

.method setWindowMangificationSpec(FFF)V
    .locals 1
    .parameter "scale"
    .parameter "offsetX"
    .parameter "offsetY"
...
.method updateDisplayContent(Lcom/android/server/wm/DisplayContent;)V
    .locals 2
    .parameter "displayContent"
    ...
    iput v1, v0, Lcom/android/server/input/InputWindowHandle;->parentDisplayId:I

    .line 439
    return-void
.end method

.method updateWindowDisplay()V
    .locals 3
    ...
    iput v0, p0, Lcom/android/server/wm/WindowState;->mWindowDisplayId:I
    ...
    .line 463
    :cond_0
    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mSmartShowContext:Lcom/android/server/FullSmartShowContext;

    const/4 v1, 0x0

    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->getSmartShowData()Ljava/lang/Object;
