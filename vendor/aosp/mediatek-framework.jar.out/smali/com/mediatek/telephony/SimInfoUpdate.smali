...
.method public static setDefaultNameForNewSim(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    iget v2, v0, Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;->mNameSource:I

    int-to-long v15, v2

    .line 579
    .local v15, oriNameSource:J
    move-object/from16 v0, v18
    ...
    .line 580
    .local v17, simDisplayName:Ljava/lang/String;
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "[setDefaultNameForNewSim] SimInfo simId is "
    ...
    const-string v3, " simDisplayName is "
    ...
    invoke-static {v0, v1}, Lcom/mediatek/telephony/SimInfoManager;->getOperatorBySlot(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v19

    .line 589
    .local v19, strOperator:Ljava/lang/String;
    if-eqz v19, :cond_5
    ...
    .line 592
    .local v5, strCTName:Ljava/lang/String;
    move-object/from16 v0, v17
    ...
    invoke-static/range {v2 .. v7}, Lcom/mediatek/telephony/SimInfoManager;->setDefaultNameEx(Landroid/content/Context;JLjava/lang/String;J)I

    .line 604
    .end local v5           #strCTName:Ljava/lang/String;
    .end local v19           #strOperator:Ljava/lang/String;
    :cond_3
    :goto_0
    invoke-static/range {p2 .. p2}, Lcom/mediatek/telephony/SimInfoUpdate;->broadcastSetDefaultNameDone(I)V

    .line 607
    .end local v14           #optr:Ljava/lang/String;
    .end local v15           #oriNameSource:J
    .end local v17           #simDisplayName:Ljava/lang/String;
    :cond_4
    return-void

    .line 597
    .restart local v14       #optr:Ljava/lang/String;
    .restart local v15       #oriNameSource:J
    .restart local v17       #simDisplayName:Ljava/lang/String;
    .restart local v19       #strOperator:Ljava/lang/String;
    :cond_5
    const-string v2, "NOT CT Card"
    ...
    iget-wide v9, v0, Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;->mSimInfoId:J
    ...
    invoke-static/range {v8 .. v13}, Lcom/mediatek/telephony/SimInfoManager;->setDefaultNameEx(Landroid/content/Context;JLjava/lang/String;J)I
...
.method private static setDefaultNameIfImsiReadyOrLocked(Ljava/util/List;)V
    ...
    const-string v1, "[setDefaultNameIfImsiReadyOrLocked] nSimCount is "
    ...
    .line 556
    .local v8, temp:Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;
    iget-object v0, v8, Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;->mDisplayName:Ljava/lang/String;
    ...
    const-string v1, "[setDefaultNameIfImsiReadyOrLocked] the "
    ...
    const-string v1, "th mDisplayName is null"
    ...
    .line 558
    sget-object v0, Lcom/mediatek/telephony/SimInfoUpdate;->DEFAULTSIMSETTING_PROPERTY_ICC_OPERATOR_DEFAULT_NAME:[Ljava/lang/String;
    ...
    const-string v1, "[setDefaultNameIfImsiReadyOrLocked] operatorName is "
    ...
    iget-wide v1, v8, Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;->mSimInfoId:J
    ...
    .end local v4           #nameSource:J
    .end local v6           #i:I
    .end local v7           #nSimCount:I
    .end local v8           #temp:Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;
    :cond_1
    invoke-interface {p0}, Ljava/util/List;->size()I
