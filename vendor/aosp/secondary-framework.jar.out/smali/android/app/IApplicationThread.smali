...
.field public static final DUMP_ALL_MESSAGE_HISTORY_TRANSACTION:I = 0x34
...
.field public static final DUMP_MESSAGE_HISTORY_TRANSACTION:I = 0x30

.field public static final DUMP_PROVIDER_TRANSACTION:I = 0x2d

.field public static final DUMP_SERVICE_TRANSACTION:I = 0x16

.field public static final ENABLE_LOOPER_LOG:I = 0x31
...
.field public static final RESET_SL_TRANSACTION:I = 0x33
...
.field public static final SCHEDULE_DISPLAY_CHANGED_TRANSACTION:I = 0x35
...
.field public static final SCHEDULE_SENSOR_CHANGED_TRANSACTION:I = 0x36
...
.field public static final SET_TRIM_MEMORY_FLAG_EX:I = 0x32
...
# virtual methods
.method public abstract ResetSL()V
...
.method public abstract dumpAllMessageHistory()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract dumpMessageHistory()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract enableLooperLog()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleConfigurationChanged(Landroid/content/res/Configuration;I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleCreateService(Landroid/os/IBinder;Landroid/content/pm/ServiceInfo;Landroid/content/res/CompatibilityInfo;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleDisplayChanged(Landroid/os/IBinder;Landroid/content/res/Configuration;II)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleReceiver(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Landroid/content/res/CompatibilityInfo;ILjava/lang/String;Landroid/os/Bundle;ZI)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleRegisteredReceiver(Landroid/content/IIntentReceiver;Landroid/content/Intent;ILjava/lang/String;Landroid/os/Bundle;ZZI)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleSensorChanged(Landroid/os/IBinder;Landroid/content/res/Configuration;II)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setHttpProxy(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setTrimMemoryFlagEx()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
