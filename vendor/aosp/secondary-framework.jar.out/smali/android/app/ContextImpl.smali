...
.field private mDefaultRes:Landroid/content/res/Resources;
...
.field public mWindowService:Ljava/lang/Object;
...
.method constructor <init>()V
    ...
    .line 231
    iput-object v1, p0, Landroid/app/ContextImpl;->mDataDir:Ljava/io/File;

    .line 235
    iput v2, p0, Landroid/app/ContextImpl;->mContextId:I

    .line 236
    iput v2, p0, Landroid/app/ContextImpl;->mTaskId:I

    .line 237
    iput v2, p0, Landroid/app/ContextImpl;->mDisplayId:I

    .line 238
    iput v2, p0, Landroid/app/ContextImpl;->mDataId:I

    .line 240
    iput-object v1, p0, Landroid/app/ContextImpl;->mWindowService:Ljava/lang/Object;

    .line 242
    iput-object v1, p0, Landroid/app/ContextImpl;->ssContext:Landroid/content/SmartShowContext;
    ...
    iput-object v0, p0, Landroid/app/ContextImpl;->ssContext:Landroid/content/SmartShowContext;
...
.method private getDataDirFile()Ljava/io/File;
    ...
    .line 2065
    iget v2, p0, Landroid/app/ContextImpl;->mDataId:I
    ...
    invoke-virtual {v2}, Landroid/app/LoadedApk;->getDataDirFile()Ljava/io/File;
    ...
    .line 2068
    :cond_0
    iget-object v2, p0, Landroid/app/ContextImpl;->mDataDir:Ljava/io/File;
    ...
    invoke-virtual {v2}, Landroid/app/LoadedApk;->getDataDir()Ljava/lang/String;
    ...
    .line 2073
    .local v1, oldDataDir:Ljava/lang/String;
    if-eqz v0, :cond_2
    ...
    iget v3, p0, Landroid/app/ContextImpl;->mDataId:I
    ...
    iput-object v2, p0, Landroid/app/ContextImpl;->mDataDir:Ljava/io/File;
    ...
    .line 2080
    iget-object v2, p0, Landroid/app/ContextImpl;->ssContext:Landroid/content/SmartShowContext;
    ...
    invoke-virtual {v2, v3, v4}, Landroid/content/SmartShowContext;->symlink(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local v1           #oldDataDir:Ljava/lang/String;
    :cond_2
...
.method private updateResources()V
    ...
    invoke-virtual {p0}, Landroid/app/ContextImpl;->getContextId()I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/app/ActivityThread;->updateResource(II)V
...
.method public createConfigurationContext(Landroid/content/res/Configuration;)Landroid/content/Context;
    ...
    invoke-virtual {p0}, Landroid/app/ContextImpl;->getTaskId()I

    move-result v1

    invoke-virtual {v6, v0, v1}, Landroid/app/ContextImpl;->setContextAndTaskId(II)V
    ...
    invoke-virtual {v6}, Landroid/app/ContextImpl;->getContextId()I
...
.method public createDisplayContext(Landroid/view/Display;)Landroid/content/Context;
    ...
    invoke-virtual {p0, v4}, Landroid/app/ContextImpl;->getCompatibilityInfo(I)Landroid/view/CompatibilityInfoHolder;
    ...
    iget-object v5, p0, Landroid/app/ContextImpl;->ssContext:Landroid/content/SmartShowContext;

    const/16 v6, 0xa

    invoke-virtual {v5, v6, v7, v8}, Landroid/content/SmartShowContext;->perform(IILjava/lang/Object;)I

    move-result v3

    .line 2042
    .local v3, contextId:I
    invoke-virtual {v2, v3, v7}, Landroid/app/ContextImpl;->setContextAndTaskId(II)V
    ...
    invoke-virtual {v2, v5, v8, v6}, Landroid/app/ContextImpl;->init(Landroid/app/LoadedApk;Landroid/os/IBinder;Landroid/app/ActivityThread;)V
...
.method public getApplicationInfo()Landroid/content/pm/ApplicationInfo;
    ...
    .line 862
    .local v1, ret:Landroid/content/pm/ApplicationInfo;
    iget-object v0, v1, Landroid/content/pm/ApplicationInfo;->dataDir:Ljava/lang/String;

    .line 863
    .local v0, oldDataDir:Ljava/lang/String;
    ...
    .line 879
    .end local v0           #oldDataDir:Ljava/lang/String;
    .end local v1           #ret:Landroid/content/pm/ApplicationInfo;
    :cond_3
    new-instance v2, Ljava/lang/RuntimeException;
...
.method public getContextId()I
    ...
    .prologue
    .line 256
    iget v0, p0, Landroid/app/ContextImpl;->mContextId:I
...
.method public getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    .prologue
    .line 905
    sget-object v5, Landroid/app/ContextImpl;->sSharedPrefs:Ljava/util/HashMap;

    monitor-enter v5

    .line 906
    :try_start_0
    iget v4, p0, Landroid/app/ContextImpl;->mDataId:I
    ...
    iget v6, p0, Landroid/app/ContextImpl;->mDataId:I
    ...
    .restart local v0       #prefsFile:Ljava/io/File;
    :cond_1
    new-instance v4, Ljava/lang/StringBuilder;
...
.method public getTaskId()I
    ...
    .prologue
    .line 261
    iget v0, p0, Landroid/app/ContextImpl;->mTaskId:I
...
.method final init(Landroid/app/LoadedApk;Landroid/os/IBinder;Landroid/app/ActivityThread;Landroid/content/res/Resources;Ljava/lang/String;Landroid/os/UserHandle;)V
    ...
    iget v1, v1, Landroid/content/pm/ApplicationInfo;->dataId:I

    iput v1, p0, Landroid/app/ContextImpl;->mDataId:I
    ...
    invoke-virtual {v1, p3}, Landroid/app/LoadedApk;->getResources(Landroid/app/ActivityThread;)Landroid/content/res/Resources;
    ...
    invoke-virtual/range {v1 .. v6}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;I)Landroid/content/res/Resources;
    ...
    iput-object v1, p0, Landroid/app/ContextImpl;->mDefaultRes:Landroid/content/res/Resources;
    ...
    .line 2160
    .local v8, curResClass:Ljava/lang/Class;
    const/4 v10, 0x0

    .line 2162
    .local v10, resClass:Ljava/lang/Class;
    :try_start_0
    ...
    .line 2170
    .end local v8           #curResClass:Ljava/lang/Class;
    .end local v10           #resClass:Ljava/lang/Class;
    :cond_1
    invoke-virtual {p0}, Landroid/app/ContextImpl;->getContextId()I
    ...
    invoke-virtual/range {v1 .. v6}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/app/LoadedApk;I)Landroid/content/res/Resources;
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/app/ActivityThread;->putTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/app/LoadedApk;ILandroid/content/res/Resources;)V

    goto :goto_2

    .line 2163
    .restart local v8       #curResClass:Ljava/lang/Class;
    .restart local v10       #resClass:Ljava/lang/Class;
    :catch_0
    move-exception v1
...
.method public isInDualScreenMode()Z
    .locals 2

    .prologue
    .line 251
    iget-object v0, p0, Landroid/app/ContextImpl;->ssContext:Landroid/content/SmartShowContext;
...
.method public setContextAndTaskId(II)V
    ...
    .prologue
    .line 266
    iput p1, p0, Landroid/app/ContextImpl;->mContextId:I

    .line 267
    iput p2, p0, Landroid/app/ContextImpl;->mTaskId:I
...
.method public setDisplayId(I)V
    ...
    .prologue
    .line 272
    iget v1, p0, Landroid/app/ContextImpl;->mDisplayId:I

    if-eq v1, p1, :cond_1

    .line 273
    iput p1, p0, Landroid/app/ContextImpl;->mDisplayId:I

    .line 274
    iget-object v1, p0, Landroid/app/ContextImpl;->mWindowService:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, Landroid/app/ContextImpl;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget v2, p0, Landroid/app/ContextImpl;->mDisplayId:I

    invoke-virtual {v0, v1, v2}, Landroid/hardware/display/DisplayManager;->getDisplay(II)Landroid/view/Display;
    ...
    :goto_0
    invoke-direct {p0}, Landroid/app/ContextImpl;->updateResources()V
    ...
    iput-object v1, p0, Landroid/app/ContextImpl;->mExternalFilesDir:Ljava/io/File;
    ...
    invoke-virtual {v1, v2}, Landroid/view/Display;->setDisplayId(I)V
...
.method public updateRoute(IIII)V
    .locals 5
    .parameter "command"
    .parameter "source"
    .parameter "pid"
    ...
    .line 307
    iget-object v0, p0, Landroid/app/ContextImpl;->mServiceCache:Ljava/util/ArrayList;
    ...
    .line 310
    :try_start_0
    iget v3, v1, Landroid/app/ContextImpl$ServiceFetcher;->mContextCacheIndex:I
    ...
    .line 313
    check-cast v2, Landroid/hardware/SystemSensorManager;

    .end local v2           #service:Ljava/lang/Object;
    invoke-virtual {v2, p1, p2, p3, p4}, Landroid/hardware/SystemSensorManager;->updateRoute(IIII)I
    ...
    .line 318
    .end local v0           #cache:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/Object;>;"
    :cond_1
    return-void

    .line 316
    .restart local v0       #cache:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/Object;>;"
    :catchall_0
    move-exception v3
...
.method public updateSensorRotation(IZ)V
    .locals 5
    .parameter "rotation"
    .parameter "reset"
    ...
    .end local v2           #service:Ljava/lang/Object;
    invoke-virtual {v2, p1, p2}, Landroid/hardware/SystemSensorManager;->setPreProcessingMode(IZ)V
