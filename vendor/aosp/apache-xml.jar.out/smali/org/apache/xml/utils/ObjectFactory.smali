...
.method private static findJarServiceProviderName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 548
    const-class v10, Lorg/apache/xml/utils/ObjectFactory;
    ...
    invoke-static {v10}, Lorg/apache/xml/utils/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
...
.method static lookUpFactoryClassName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 265
    .local v10, ss:Lorg/apache/xml/utils/SecuritySupport;
    :try_start_0
    move-object/from16 v0, p0

    invoke-virtual {v10, v0}, Lorg/apache/xml/utils/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13}, Lorg/apache/xml/utils/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/SecurityException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v10, v13}, Lorg/apache/xml/utils/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_2
    invoke-virtual {v10, v7}, Lorg/apache/xml/utils/SecuritySupport;->getFileExists(Ljava/io/File;)Z
    :try_end_2
    ...
    :goto_1
    const-class v14, Lorg/apache/xml/utils/ObjectFactory;
    ...
    :try_start_3
    sget-wide v15, Lorg/apache/xml/utils/ObjectFactory;->fLastModified:J
    ...
    invoke-virtual {v10, v6}, Lorg/apache/xml/utils/SecuritySupport;->getLastModified(Ljava/io/File;)J

    move-result-wide v17

    sput-wide v17, Lorg/apache/xml/utils/ObjectFactory;->fLastModified:J
    ...
    sput-object v13, Lorg/apache/xml/utils/ObjectFactory;->fXalanProperties:Ljava/util/Properties;

    .line 321
    invoke-virtual {v10, v6}, Lorg/apache/xml/utils/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;

    move-result-object v3

    .line 322
    sget-object v13, Lorg/apache/xml/utils/ObjectFactory;->fXalanProperties:Ljava/util/Properties;
    ...
    sput-wide v13, Lorg/apache/xml/utils/ObjectFactory;->fLastModified:J
    ...
    :try_start_6
    sput-wide v15, Lorg/apache/xml/utils/ObjectFactory;->fLastModified:J
    ...
    invoke-virtual {v10, v13}, Lorg/apache/xml/utils/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    .line 375
    :cond_a
    invoke-static/range {p0 .. p0}, Lorg/apache/xml/utils/ObjectFactory;->findJarServiceProviderName(Ljava/lang/String;)Ljava/lang/String;
