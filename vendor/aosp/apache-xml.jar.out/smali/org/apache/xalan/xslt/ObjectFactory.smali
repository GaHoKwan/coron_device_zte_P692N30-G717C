...
.method static lookUpFactoryClassName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 265
    .local v10, ss:Lorg/apache/xalan/xslt/SecuritySupport;
    :try_start_0
    move-object/from16 v0, p0

    invoke-virtual {v10, v0}, Lorg/apache/xalan/xslt/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13}, Lorg/apache/xalan/xslt/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/SecurityException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v10, v13}, Lorg/apache/xalan/xslt/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_2
    invoke-virtual {v10, v7}, Lorg/apache/xalan/xslt/SecuritySupport;->getFileExists(Ljava/io/File;)Z
    :try_end_2
    ...
    :goto_1
    const-class v14, Lorg/apache/xalan/xslt/ObjectFactory;
    ...
    :try_start_3
    sget-wide v15, Lorg/apache/xalan/xslt/ObjectFactory;->fLastModified:J
    ...
    invoke-virtual {v10, v6}, Lorg/apache/xalan/xslt/SecuritySupport;->getLastModified(Ljava/io/File;)J

    move-result-wide v17

    sput-wide v17, Lorg/apache/xalan/xslt/ObjectFactory;->fLastModified:J
    ...
    sput-object v13, Lorg/apache/xalan/xslt/ObjectFactory;->fXalanProperties:Ljava/util/Properties;

    .line 321
    invoke-virtual {v10, v6}, Lorg/apache/xalan/xslt/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;

    move-result-object v3

    .line 322
    sget-object v13, Lorg/apache/xalan/xslt/ObjectFactory;->fXalanProperties:Ljava/util/Properties;
    ...
    sput-wide v13, Lorg/apache/xalan/xslt/ObjectFactory;->fLastModified:J
    ...
    :try_start_6
    sput-wide v15, Lorg/apache/xalan/xslt/ObjectFactory;->fLastModified:J
    ...
    invoke-virtual {v10, v13}, Lorg/apache/xalan/xslt/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
