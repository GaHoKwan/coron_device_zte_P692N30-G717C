...
.method public canTake(Ljava/lang/Object;)Z
    ...
    .line 113
    const-class v10, Lcom/android/internal/telephony/sip/SipPhone;

    monitor-enter v10

    .line 114
    :try_start_0
    instance-of v11, p1, Landroid/net/sip/SipAudioCall;
    ...
    .line 115
    :cond_0
    iget-object v11, p0, Lcom/android/internal/telephony/sip/SipPhone;->ringingCall:Lcom/android/internal/telephony/sip/SipPhone$SipCall;

    invoke-virtual {v11}, Lcom/android/internal/telephony/sip/SipPhone$SipCall;->getState()Lcom/android/internal/telephony/Call$State;
    ...
    :cond_1
    :try_start_1
    iget-object v11, p0, Lcom/android/internal/telephony/sip/SipPhone;->foregroundCall:Lcom/android/internal/telephony/sip/SipPhone$SipCall;
    ...
    iget-object v11, p0, Lcom/android/internal/telephony/sip/SipPhone;->backgroundCall:Lcom/android/internal/telephony/sip/SipPhone$SipCall;
    ...
    iget-object v11, p0, Lcom/android/internal/telephony/sip/SipPhone;->mCM:Lcom/android/internal/telephony/CallManager;
    ...
    .line 133
    const-string v9, "SipPhone"

    const-string/jumbo v11, "reject sip incoming because video call is exists"
    ...
    invoke-virtual {v11}, Lcom/android/internal/telephony/CallManager;->getRingingCallCount()I
    ...
    const-string/jumbo v11, "reject sip incoming because other MT call exists"
    ...
    :cond_5
    :try_start_6
    const-string v11, "SipPhone"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "+++ taking call from: "
    ...
    iget-object v11, p0, Lcom/android/internal/telephony/sip/SipPhone;->mProfile:Landroid/net/sip/SipProfile;
    ...
    invoke-virtual {v11, v7, v6}, Lcom/android/internal/telephony/sip/SipPhone$SipCall;->initIncomingCall(Landroid/net/sip/SipAudioCall;Z)V
    ...
    const-string v12, "    call cancelled !!"
    ...
    invoke-virtual {v11}, Lcom/android/internal/telephony/sip/SipPhone$SipCall;->reset()V
    :try_end_6
    ...
    iget-object v9, p0, Lcom/android/internal/telephony/sip/SipPhone;->ringingCall:Lcom/android/internal/telephony/sip/SipPhone$SipCall;
...
.method public switchHoldingAndActive()V
    ...
    const-string/jumbo v2, "wrong state to merge calls: fg="
