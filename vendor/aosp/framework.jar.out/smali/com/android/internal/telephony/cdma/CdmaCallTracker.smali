...
.method private handleCallWaitingInfo(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V
    ...
    iget-object v9, v9, Lcom/android/internal/telephony/cdma/CdmaCall;->connections:Ljava/util/ArrayList;
    ...
    const-string v11, "handleCallWaitingInfo before formate number = "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, p1, Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;->number:Ljava/lang/String;
    ...
    iget-object v9, p1, Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;->number:Ljava/lang/String;

    invoke-static {v9}, Lcom/android/internal/telephony/cdma/PlusCodeToIddNddUtils;->removeIddNddAddPlusCode(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1131
    iget v9, p1, Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;->numberType:I
    ...
    const-string v11, "handleCallWaitingInfo after formate number = "
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/cdma/CdmaCall;->getConnections()Ljava/util/List;

    move-result-object v5

    .line 1139
    .local v5, fgConns:Ljava/util/List;
    const/4 v4, 0x0

    .line 1140
    .local v4, fgConnCount:I
    if-eqz v5, :cond_2
    ...
    .line 1147
    .local v3, fgConn:Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getRealAcceptTime()J
    ...
    const-string v10, "handleCallWaitingInfo CallWaiting invalid, return"

    invoke-static {v9, v10}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1173
    .end local v1           #curTime:J
    .end local v3           #fgConn:Lcom/android/internal/telephony/cdma/CdmaConnection;
    .end local v4           #fgConnCount:I
    .end local v5           #fgConns:Ljava/util/List;
    .end local v6           #i:I
    ...
    .restart local v3       #fgConn:Lcom/android/internal/telephony/cdma/CdmaConnection;
    .restart local v4       #fgConnCount:I
    .restart local v5       #fgConns:Ljava/util/List;
    ...
    .end local v3           #fgConn:Lcom/android/internal/telephony/cdma/CdmaConnection;
    :cond_4
    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->ringingCall:Lcom/android/internal/telephony/cdma/CdmaCall;

    invoke-virtual {v9}, Lcom/android/internal/telephony/cdma/CdmaCall;->getLatestConnection()Lcom/android/internal/telephony/Connection;
    ...
    .line 1156
    .local v7, lastRingConn:Lcom/android/internal/telephony/cdma/CdmaConnection;
    if-eqz v7, :cond_5
    ...
    invoke-virtual {v7}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getCreateTime()J
    ...
    invoke-virtual {v9, v7}, Lcom/android/internal/telephony/cdma/CdmaCall;->detach(Lcom/android/internal/telephony/cdma/CdmaConnection;)V

    .line 1160
    const-string v9, "CDMA"

    const-string v10, "handleCallWaitingInfo detach last RingConn"
    ...
    .end local v5           #fgConns:Ljava/util/List;
    .end local v6           #i:I
    .end local v7           #lastRingConn:Lcom/android/internal/telephony/cdma/CdmaConnection;
    .end local v8           #number:Ljava/lang/String;
    :cond_5
    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->ringingCall:Lcom/android/internal/telephony/cdma/CdmaCall;
    ...
    iget-object v11, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->ringingCall:Lcom/android/internal/telephony/cdma/CdmaCall;

    invoke-direct {v9, v10, p1, p0, v11}, Lcom/android/internal/telephony/cdma/CdmaConnection;-><init>(Landroid/content/Context;Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;Lcom/android/internal/telephony/cdma/CdmaCallTracker;Lcom/android/internal/telephony/cdma/CdmaCall;)V
...
.method acceptCall()V
    ...
    .prologue
    .line 368
    iget-object v7, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->ringingCall:Lcom/android/internal/telephony/cdma/CdmaCall;
    ...
    .line 378
    .local v1, curTime:J
    invoke-virtual {v3, v1, v2}, Lcom/android/internal/telephony/cdma/CdmaConnection;->setRealAcceptTime(J)V
    ...
    const-string v9, "acceptCall: callwaiting count = "
    ...
    const-string v9, "acceptCall: ringConn number = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, v5, Lcom/android/internal/telephony/cdma/CdmaConnection;->address:Ljava/lang/String;
    ...
    invoke-virtual {v7, v5}, Lcom/android/internal/telephony/cdma/CdmaCall;->detach(Lcom/android/internal/telephony/cdma/CdmaConnection;)V
    ...
    const-string/jumbo v8, "phone not ringing"
...
.method dial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    const-string/jumbo v5, "yangli send EVENT_CDMA_DIAL_THREEWAY_DELAY"
    ...
    const-string/jumbo v5, "wangjw exit emergency callback mode when dial threeway"
    ...
    invoke-virtual {v4, p0, v5, p1}, Lcom/android/internal/telephony/cdma/CDMAPhone;->setOnThreeWayEcmExitResponse(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v9, "Event EVENT_CDMA_CALL_ACCEPTED Received"
    ...
    const-string/jumbo v10, "yangli Event EVENT_CDMA_DIAL_THREEWAY_DELAY Received dialString = "
    ...
    const-string/jumbo v10, "wangjw dial threeway after exit ECM pendingCallInEcm = "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-boolean v10, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->pendingCallInEcm:Z
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v23, "poll: hangupPendingMO, hangup conn "
    ...
    const-string/jumbo v23, "unexpected error on hangup"
    ...
    const-string/jumbo v23, "pendingMo="
    ...
    const-string/jumbo v23, "missed/rejected call, conn.cause="
    ...
    const-string/jumbo v23, "setting cause to "
...
.method setPpuAndCurrency(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    .prologue
    .line 1589
    const-string/jumbo v0, "setPpuAndCurrency"
